...
const NAV_LINKS = (
  <>
    <Link to="/docs" className="transition-colors hover:opacity-100">
      docs
    </Link>
    <a href="/#install" className="transition-colors hover:opacity-100">
      install
    </a>
    <a href="/#features" className="transition-colors hover:opacity-100">
      features
    </a>
    <a
        ...
        {isLanding && !scrolled ? (
          ...
          >
            ...
            <nav className="hidden items-center gap-6 text-[11px] uppercase tracking-[0.08em] text-primary-foreground/70 lg:flex">
              <Link to="/docs" className="transition-colors hover:text-primary-foreground">
                docs
              </Link>
              <a href="/#install" className="transition-colors hover:text-primary-foreground">
                install
              </a>
