...
import { S as SiteNav, a as SiteFooter } from "./site-nav-Dsy2VtFS.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ProvidersStrip, {}),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CopyCmd, {
                  cmd: "npm i -g @devang0907/agent-dev",
                  variant: "hero",
                }),
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
            ...
            children: SHOWCASE_TABS.map((item) =>
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  onClick: () => setActive(item.id),
                  className: `shrink-0 border-b-2 pb-4 text-left transition-colors ${active === item.id ? "border-foreground text-foreground" : "border-transparent text-foreground/45 hover:text-foreground/70"}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", {
                  className: "ref-section-title text-foreground",
                  children: tab.title,
                }),
...
function CopyCmd({ cmd, variant = "default" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("button", {
    ...
    children: isHero
      ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
          children: copied ? "Copied ✓" : "Get started",
        })
...
function TerminalDemo({ compact = false }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
    className: `overflow-hidden bg-terminal text-terminal-foreground ${compact ? "rounded-xl" : "rounded-[18px] sm:rounded-[20px]"}`,
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("pre", {
        className: `terminal-mono overflow-x-auto leading-relaxed ${compact ? "px-4 py-4 text-[10px]" : "px-6 py-6 text-[12px]"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
            ...
            children: "free/llama-3.3-70b · BOSS",
          }),
          "\n\n",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
            className: "text-primary",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
            ...
            children: "delegate → explore worker",
          }),
          "\n",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
            className: "text-white/60",
            children: "auth middleware patterns",
          }),
          "\n",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
            className: "text-purple-400",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
            className: "text-white/60",
            children: "delegate → implement worker",
          }),
          "\n",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
            className: "text-green-400",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
            className: "text-white/60",
            children: "delegate → shell worker",
          }),
          "\n",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", {
            className: "text-green-400",
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", {
        ...
        children: providers.map((provider) =>
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: provider }, provider),
        ),
      }),
    ],
  });
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", {
                  className: `text-sm font-bold ${f.color}`,
                  children: f.title,
                }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", {
    ...
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", {
            className: "editorial-section-title text-3xl sm:text-5xl",
            children: title,
          }),
        ],
      }),
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("pre", {
        ...
        children: lines.map((l) =>
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: l }, l),
        ),
      }),
    ],
  });
