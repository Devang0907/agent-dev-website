...
import { S as SiteNav, a as SiteFooter } from "./site-nav-6c6uAbIN.mjs";
...
function LogoTicker() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "overflow-hidden py-10 sm:py-12", "aria-label": "Supported AI providers", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-y-0 left-0 z-10 w-16 bg-linear-to-r from-[#f3f2ee] to-transparent sm:w-24" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none absolute inset-y-0 right-0 z-10 w-16 bg-linear-to-l from-[#f3f2ee] to-transparent sm:w-24" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "logo-ticker-track gap-12 px-6 sm:gap-16 sm:px-8", children: items.map((provider, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex shrink-0 items-center gap-3", children: [
...
function FeatureSpotlight() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "mx-3 pt-2 pb-8 sm:mx-4 sm:pt-4 lg:mx-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-frame ref-sky-bg editorial-shadow overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-black/8 px-4 pt-8 sm:px-8 sm:pt-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "ref-section-title mb-8 text-center text-foreground sm:mb-10", children: "Empowering autonomous development" }),
