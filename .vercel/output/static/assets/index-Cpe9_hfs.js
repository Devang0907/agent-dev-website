import { r as Dn, j as R, g as cr } from "./index-Bt-2xMU-.js";
import { c as Ge, S as Ti, a as Bi } from "./site-nav-CXOhri2k.js";
function Pi(e) {
  const t = [];
  let n = null;
  for (const r of e)
    r.level === 2 ? ((n = { section: r, children: [] }), t.push(n)) : n && n.children.push(r);
  return t;
}
function Dt({ item: e, activeId: t, nested: n = !1, onSelect: r }) {
  const i = t === e.id;
  return R.jsxs("button", {
    ...
    className: Ge(
      ...
      n ? "py-1 pl-3 pr-2 text-[11px] leading-snug" : "py-1.5 pl-3 pr-2 text-xs leading-snug",
      i
...
function Li({ items: e }) {
  const t = Dn.useMemo(() => Pi(e), [e]),
    [n, r] = Dn.useState(e[0]?.id ?? "");
  Dn.useEffect(() => {
    const o = e.map((u) => document.getElementById(u.id)).filter((u) => u !== null);
    if (o.length === 0) return;
    const l = new IntersectionObserver(
      (u) => {
        const a = u
          .filter((s) => s.isIntersecting)
          .sort((s, f) => s.boundingClientRect.top - f.boundingClientRect.top);
        a.length > 0 && r(a[0].target.id);
      },
      { rootMargin: "-120px 0px -55% 0px", threshold: 0 },
    );
    for (const u of o) l.observe(u);
    return () => l.disconnect();
  }, [e]);
  const i = (o) => {
    const l = document.getElementById(o);
    if (!l) return;
    const u = l.getBoundingClientRect().top + window.scrollY - 116;
  ...
  return R.jsxs(R.Fragment, {
    children: [
      R.jsxs("nav", {
        className: "docs-toc-mobile mb-8 lg:hidden",
        children: [
          R.jsx("p", {
          ...
          R.jsx("div", {
            className: "docs-toc-mobile-scroll flex gap-2 overflow-x-auto pb-1",
            children: t.map((o) =>
              R.jsx(
                "button",
                {
                  type: "button",
                  onClick: () => i(o.section.id),
                  className: Ge(
                    "shrink-0 rounded-sm border px-2.5 py-1 text-[11px] transition-colors",
                    n === o.section.id || o.children.some((l) => l.id === n)
                      ? "border-primary bg-primary/10 text-foreground"
                      : "border-border text-muted-foreground hover:border-foreground/30 hover:text-foreground",
                  ),
                  children: o.section.text,
                },
                o.section.id,
              ),
            ),
      ...
      R.jsx("aside", {
        ...
        children: R.jsxs("nav", {
          className: "docs-toc-panel nav-sticky-top sticky rounded-md border border-border bg-card",
          children: [
            R.jsx("div", {
              className:
                "border-b border-border px-4 py-2.5 text-[10px] uppercase tracking-wider text-muted-foreground",
              children: "On this page",
            }),
            R.jsx("div", {
              className:
                "docs-toc-scroll max-h-[calc(100vh-var(--nav-offset)-1rem)] overflow-y-auto px-2 py-2",
              children: R.jsx("ul", {
                className: "space-y-3",
                children: t.map((o) =>
                  R.jsxs(
                    ...
                    {
                      children: [
                        R.jsx(Dt, { item: o.section, activeId: n, onSelect: i }),
                        o.children.length > 0 &&
                          R.jsx("ul", {
                            className: "mt-0.5 space-y-0.5 border-l border-border/80 pl-2",
...
const _i = /^[$_\p{ID_Start}][$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
  Oi = /^[$_\p{ID_Start}][-$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
  zi = {};
function yt(e, t) {
  return (zi.jsx ? Oi : _i).test(e);
}
const Mi = /[ \t\n\f\r]/g;
function Ni(e) {
  return typeof e == "object" ? (e.type === "text" ? kt(e.value) : !1) : kt(e);
}
function kt(e) {
  return e.replace(Mi, "") === "";
}
...
class Wn extends ne {
  constructor(t, n, r, i) {
    let o = -1;
    if ((super(t, n), xt(this, "space", i), typeof r == "number"))
      for (; ++o < yn.length; ) {
        const l = yn[o];
        xt(this, yn[o], (r & Mn[l]) === Mn[l]);
      }
  }
}
...
function Re(e) {
  ...
  for (const [r, i] of Object.entries(e.properties)) {
    const o = new Wn(r, e.transform(e.attributes || {}, r), i, e.space);
...
function Gi(e, t) {
  ...
  if (n.length > 4 && n.slice(0, 4) === "data" && $i.test(t)) {
    if (t.charAt(4) === "-") {
      const o = t.slice(5).replace(bt, Yi);
      r = "data" + o.charAt(0).toUpperCase() + o.slice(1);
    } else {
      const o = t.slice(4);
      if (!bt.test(o)) {
        let l = o.replace(Vi, Wi);
...
const Ki = fr([hr, Ui, dr, gr, Dr], "html"),
  Yn = fr([hr, qi, dr, gr, Dr], "svg");
function Qi(e) {
  return e.join(" ").trim();
}
var Be = {},
...
`,
  ...
  function g(F, D) {
    ...
    function _(B) {
      var S = B.match(t);
      S && (E += S.length);
      var V = B.lastIndexOf(a);
      w = ~V ? B.length - V : w + B.length;
    }
    function O() {
      var B = { line: E, column: w };
      return function (S) {
        return ((S.position = new x(B)), U(), S);
      };
    }
    function x(B) {
      ((this.start = B), (this.end = { line: E, column: w }), (this.source = D.source));
    }
    x.prototype.content = F;
    function M(B) {
      var S = new Error(D.source + ":" + E + ":" + w + ": " + B);
      if (
        ((S.reason = B),
        (S.filename = D.source),
        (S.line = E),
    ...
    function q(B) {
      ...
      if (S) {
        var V = S[0];
        return (_(V), (F = F.slice(V.length)), S);
      }
    }
    function U() {
      q(n);
    ...
    function y(B) {
      var S;
      for (B = B || []; (S = v()); ) S !== !1 && B.push(S);
      return B;
    }
    function v() {
      var B = O();
      if (!(s != F.charAt(0) || f != F.charAt(1))) {
        for (var S = 2; c != F.charAt(S) && (f != F.charAt(S) || s != F.charAt(S + 1)); ) ++S;
        if (((S += 2), c === F.charAt(S - 1))) return M("End of comment missing");
        var V = F.slice(2, S - 2);
        return ((w += 2), _(V), (F = F.slice(S)), (w += 2), B({ type: p, comment: V }));
      }
    }
    function I() {
      var B = O(),
        S = q(r);
      if (S) {
        if ((v(), !q(i))) return M("property missing ':'");
        var V = q(o),
          K = B({ type: h, property: b(S[0].replace(e, c)), value: V ? b(V[0].replace(e, c)) : c });
        return (q(l), K);
      }
    }
    function H() {
      var B = [];
      y(B);
      for (var S; (S = I()); ) S !== !1 && (B.push(S), y(B));
      return B;
    }
    return (U(), H());
  }
  function b(F) {
    return F ? F.replace(u, c) : c;
  }
  return ((kn = g), kn);
}
var wt;
function Ji() {
  ...
  (Object.defineProperty(Be, "__esModule", { value: !0 }), (Be.default = n));
  const t = e(Xi());
  function n(r, i) {
    let o = null;
    ...
    return (
      l.forEach((a) => {
        ...
        const { property: s, value: f } = a;
        u ? i(s, f, a) : f && ((o = o || {}), (o[s] = f));
      }),
      o
    );
  }
...
function Zi() {
  if (Ct) return Ne;
  ((Ct = 1), Object.defineProperty(Ne, "__esModule", { value: !0 }), (Ne.camelCase = void 0));
  var e = /^--[a-zA-Z0-9_-]+$/,
    t = /-([a-z])/g,
    n = /^[^-]+$/,
    ...
    a = function (s, f) {
      return (
        ...
        o(s)
          ? s
          : ((s = s.toLowerCase()),
            f.reactCompat ? (s = s.replace(i, u)) : (s = s.replace(r, u)),
            s.replace(t, l))
      );
    };
  return ((Ne.camelCase = a), Ne);
}
var je, Et;
function el() {
  if (Et) return je;
  ...
  function r(i, o) {
    ...
    return (
      !i ||
        typeof i != "string" ||
        (0, t.default)(i, function (u, a) {
          u && a && (l[(0, n.camelCase)(u, o)] = a);
        }),
      l
    );
  }
...
const Qn = {}.hasOwnProperty,
  il = new Map(),
  ll = /[A-Z]/g,
  ol = new Set(["table", "tbody", "thead", "tfoot", "tr"]),
  ul = new Set(["td", "th"]),
  xr = "https://github.com/syntax-tree/hast-util-to-jsx-runtime";
function al(e, t) {
...
function br(e, t, n) {
  if (t.type === "element") return sl(e, t, n);
  if (t.type === "mdxFlowExpression" || t.type === "mdxTextExpression") return cl(e, t);
  if (t.type === "mdxJsxFlowElement" || t.type === "mdxJsxTextElement") return hl(e, t, n);
  if (t.type === "mdxjsEsm") return fl(e, t);
  if (t.type === "root") return pl(e, t, n);
  if (t.type === "text") return ml(e, t);
}
function sl(e, t, n) {
  const r = e.schema;
  let i = r;
  (t.tagName.toLowerCase() === "svg" && r.space === "html" && ((i = Yn), (e.schema = i)),
    e.ancestors.push(t));
  const o = wr(e, t.tagName, !1),
    l = Dl(e, t);
  let u = Jn(e, t);
  return (
    ol.has(t.tagName) &&
      (u = u.filter(function (a) {
        return typeof a == "string" ? !Ni(a) : !0;
      })),
    Fr(e, l, o, t),
    Xn(l, u),
    e.ancestors.pop(),
...
function hl(e, t, n) {
  ...
  const o = t.name === null ? e.Fragment : wr(e, t.name, !0),
    l = yl(e, t),
    u = Jn(e, t);
  return (Fr(e, l, o, t), Xn(l, u), e.ancestors.pop(), (e.schema = r), e.create(t, o, l, n));
}
function pl(e, t, n) {
  const r = {};
  return (Xn(r, Jn(e, t)), e.create(t, e.Fragment, r, n));
}
function ml(e, t) {
  return t.value;
}
...
function gl(e, t) {
  return n;
  function n(r, i, o, l) {
    const u = Array.isArray(o.children),
      a = Kn(r);
    return t(
      i,
      o,
...
function Dl(e, t) {
  ...
  for (i in t.properties)
    if (i !== "children" && Qn.call(t.properties, i)) {
      const o = kl(e, i, t.properties[i]);
      if (o) {
        const [l, u] = o;
        e.tableCellAlignToStyle && l === "align" && typeof u == "string" && ul.has(t.tagName)
          ? (r = u)
          : (n[l] = u);
      }
    }
...
function kl(e, t, n) {
  const r = Gi(e.schema, t);
  if (!(n == null || (typeof n == "number" && Number.isNaN(n)))) {
    if ((Array.isArray(n) && (n = r.commaSeparated ? Ri(n) : Qi(n)), r.property === "style")) {
      let i = typeof n == "object" ? n : xl(e, String(n));
      return (e.stylePropertyNameCase === "css" && (i = bl(i)), ["style", i]);
    }
    return [
      e.elementAttributeNameCase === "react" && r.space
        ? Hi[r.property] || r.property
        : r.attribute,
      n,
    ];
  }
...
function xl(e, t) {
  try {
    ...
    throw ((i.file = e.filePath || void 0), (i.url = xr + "#cannot-parse-style-attribute"), i);
  }
}
function wr(e, t, n) {
  let r;
  if (!n) r = { type: "Literal", value: t };
    ...
    r =
      yt(t) && !/^[a-z]/.test(t) ? { type: "Identifier", name: t } : { type: "Literal", value: t };
  if (r.type === "Literal") {
    const i = r.value;
...
function We(e, t) {
  const n = new J("Cannot handle MDX estrees without `createEvaluater`", {
    ancestors: e.ancestors,
    place: t,
    ruleId: "mdx-estree",
    source: "hast-util-to-jsx-runtime",
  ...
  throw (
    ...
    (n.url = xr + "#cannot-handle-mdx-estrees-without-createevaluater"),
    n
  );
}
function bl(e) {
  const t = {};
  let n;
  for (n in e) Qn.call(e, n) && (t[Fl(n)] = e[n]);
  return t;
}
function Fl(e) {
  let t = e.replace(ll, wl);
...
function Er(e) {
  const t = {};
  let n = -1;
  for (; ++n < e.length; ) Al(t, e[n]);
  return t;
}
function Al(e, t) {
  let n;
  for (n in t) {
    const i = (Tt.call(e, n) ? e[n] : void 0) || (e[n] = {}),
      o = t[n];
    let l;
    if (o)
      for (l in o) {
...
const hn = xe(new RegExp("\\p{P}|\\p{S}", "u")),
  Ae = xe(/\s/);
function xe(e) {
  return t;
  function t(n) {
...
function _e(e) {
  ...
  for (; ++n < e.length; ) {
    ...
    let l = "";
    if (o === 37 && X(e.charCodeAt(n + 1)) && X(e.charCodeAt(n + 2))) i = 2;
    else if (o < 128)
...
function j(e, t, n, r) {
  ...
  return l;
  function l(a) {
    return z(a) ? (e.enter(n), u(a)) : t(a);
  }
  function u(a) {
    return z(a) && o++ < i ? (e.consume(a), u) : (e.exit(n), t(a));
  }
}
const Bl = { tokenize: Pl };
function Pl(e) {
  ...
  function r(u) {
    ...
    return (e.enter("lineEnding"), e.consume(u), e.exit("lineEnding"), j(e, t, "linePrefix"));
  }
  function i(u) {
  ...
  function l(u) {
    ...
    return T(u) ? (e.consume(u), e.exit("chunkText"), o) : (e.consume(u), l);
  }
}
const Ll = { tokenize: Rl },
  Bt = { tokenize: _l };
function Rl(e) {
  const t = this,
    n = [];
  ...
  function u(w) {
    if (r < n.length) {
      const _ = n[r];
      return ((t.containerState = _[1]), e.attempt(_[0].continuation, a, s)(w));
    }
    return s(w);
  }
  function a(w) {
    if ((r++, t.containerState._closeFlow)) {
      ...
      return (ie(t.events, O + 1, 0, t.events.slice(_)), (t.events.length = M), s(w));
    }
    return u(w);
  }
  function s(w) {
    ...
    return ((t.containerState = {}), e.check(Bt, f, c)(w));
  }
  function f(w) {
    return (i && E(), D(r), p(w));
  }
  ...
  function p(w) {
    return ((t.containerState = {}), e.attempt(Bt, h, g)(w));
  }
  function h(w) {
  ...
  function b(w) {
    if (w === null) {
      (F(e.exit("chunkFlow"), !0), D(0), e.consume(w));
      return;
    }
    return T(w)
      ? (e.consume(w), F(e.exit("chunkFlow")), (r = 0), (t.interrupt = void 0), u)
      : (e.consume(w), b);
  }
  function F(w, _) {
    ...
    if (
      ...
      for (; x--; )
        if (
          i.events[x][1].start.offset < l &&
          (!i.events[x][1].end || i.events[x][1].end.offset > l)
        )
          return;
      ...
      for (D(r), x = M; x < t.events.length; ) ((t.events[x][1].end = { ...y }), x++);
      (ie(t.events, q + 1, 0, t.events.slice(M)), (t.events.length = x));
    }
  }
  function D(w) {
    let _ = n.length;
...
const Un = { name: "attention", resolveAll: Ol, tokenize: zl };
function Ol(e, t) {
  let n = -1,
    r,
    i,
      ...
      for (r = n; r--; )
        if (
          ...
          (Pt(c, -a),
            ...
            (i = { type: a > 1 ? "strong" : "emphasis", start: { ...l.start }, end: { ...u.end } }),
            (e[r][1].end = { ...l.start }),
            (e[n][1].start = { ...u.end }),
            (s = []),
            ...
            (s = le(s, pn(t.parser.constructs.insideSpan.null, e.slice(r + 1, n), t))),
            (s = le(s, [
              ["exit", o, t],
              ["enter", u, t],
              ["exit", u, t],
...
function zl(e, t) {
  ...
  return l;
  function l(a) {
    return ((o = a), e.enter("attentionSequence"), u(a));
  }
  function u(a) {
    if (a === o) return (e.consume(a), u);
    const s = e.exit("attentionSequence"),
      f = Le(a),
      c = !f || (f === 2 && i) || n.includes(a),
...
const Ml = { name: "autolink", tokenize: Nl };
function Nl(e, t, n) {
  let r = 0;
  return i;
  function i(h) {
  ...
  function o(h) {
    return Z(h) ? (e.consume(h), l) : h === 64 ? n(h) : s(h);
  }
  function l(h) {
    return h === 43 || h === 45 || h === 46 || X(h) ? ((r = 1), u(h)) : s(h);
  }
  function u(h) {
    return h === 58
      ? (e.consume(h), (r = 0), a)
...
const Xe = { partial: !0, tokenize: jl };
function jl(e, t, n) {
  return r;
  function r(o) {
    return z(o) ? j(e, i, "linePrefix")(o) : i(o);
  }
  function i(o) {
    return o === null || T(o) ? t(o) : n(o);
  }
}
const Sr = { continuation: { tokenize: ql }, exit: Hl, name: "blockQuote", tokenize: Ul };
function Ul(e, t, n) {
  const r = this;
  return i;
  function i(l) {
...
function ql(e, t, n) {
  ...
  function o(l) {
    return e.attempt(Sr, t, n)(l);
  }
}
function Hl(e) {
  e.exit("blockQuote");
}
const vr = { name: "characterEscape", tokenize: Vl };
function Vl(e, t, n) {
  return r;
  function r(o) {
    return (
...
const Ir = { name: "characterReference", tokenize: $l };
function $l(e, t, n) {
  const r = this;
  let i = 0,
    o,
  ...
  function a(c) {
    return c === 35
      ? (e.enter("characterReferenceMarkerNumeric"),
        ...
        s)
      : (e.enter("characterReferenceValue"), (o = 31), (l = X), f(c));
  }
  function s(c) {
    return c === 88 || c === 120
      ? (e.enter("characterReferenceMarkerHexadecimal"),
        ...
        (l = Il),
        f)
      : (e.enter("characterReferenceValue"), (o = 7), (l = jn), f(c));
  }
  function f(c) {
    if (c === 59 && i) {
      const p = e.exit("characterReferenceValue");
      return l === X && !et(r.sliceSerialize(p))
        ? n(c)
        : (e.enter("characterReferenceMarker"),
          e.consume(c),
          e.exit("characterReferenceMarker"),
...
const Lt = { partial: !0, tokenize: Wl },
  Rt = { concrete: !0, name: "codeFenced", tokenize: Gl };
function Gl(e, t, n) {
  const r = this,
  ...
  function f(x) {
    return x === u
      ...
      : l < 3
        ? n(x)
        : (e.exit("codeFencedFenceSequence"), z(x) ? j(e, c, "whitespace")(x) : c(x));
  }
  function c(x) {
    return x === null || T(x)
      ? (e.exit("codeFencedFence"), r.interrupt ? t(x) : e.check(Lt, b, _)(x))
  ...
  function p(x) {
    return x === null || T(x)
      ...
      : z(x)
        ? (e.exit("chunkString"), e.exit("codeFencedFenceInfo"), j(e, h, "whitespace")(x))
        : x === 96 && x === u
          ? n(x)
          : (e.consume(x), p);
  }
  function h(x) {
    return x === null || T(x)
      ? c(x)
      : (e.enter("codeFencedFenceMeta"), e.enter("chunkString", { contentType: "string" }), g(x));
  }
  function g(x) {
    return x === null || T(x)
  ...
  function b(x) {
    return e.attempt(i, _, F)(x);
  }
  function F(x) {
    return (e.enter("lineEnding"), e.consume(x), e.exit("lineEnding"), D);
  }
  function D(x) {
    return o > 0 && z(x) ? j(e, E, "linePrefix", o + 1)(x) : E(x);
  }
  function E(x) {
    return x === null || T(x) ? e.check(Lt, b, _)(x) : (e.enter("codeFlowValue"), w(x));
  }
  function w(x) {
    return x === null || T(x) ? (e.exit("codeFlowValue"), E(x)) : (e.consume(x), w);
  }
  function _(x) {
  ...
  function O(x, M, q) {
    ...
    return y;
    function y(S) {
      return (x.enter("lineEnding"), x.consume(S), x.exit("lineEnding"), v);
    }
    function v(S) {
      return (
    ...
    function I(S) {
      return S === u ? (x.enter("codeFencedFenceSequence"), H(S)) : q(S);
    }
    function H(S) {
      return S === u
        ? (U++, x.consume(S), H)
        : U >= l
          ? (x.exit("codeFencedFenceSequence"), z(S) ? j(x, B, "whitespace")(S) : B(S))
          : q(S);
    }
    function B(S) {
      return S === null || T(S) ? (x.exit("codeFencedFence"), M(S)) : q(S);
    }
  }
}
function Wl(e, t, n) {
...
const bn = { name: "codeIndented", tokenize: Kl },
  Yl = { partial: !0, tokenize: Ql };
function Kl(e, t, n) {
  const r = this;
  return i;
  function i(s) {
  ...
  function l(s) {
    return s === null ? a(s) : T(s) ? e.attempt(Yl, l, a)(s) : (e.enter("codeFlowValue"), u(s));
  }
  function u(s) {
    return s === null || T(s) ? (e.exit("codeFlowValue"), l(s)) : (e.consume(s), u);
  }
  function a(s) {
...
const Xl = { name: "codeText", previous: Zl, resolve: Jl, tokenize: eo };
function Jl(e) {
  let t = e.length - 4,
    n = 3,
    r,
...
function eo(e, t, n) {
  ...
  function u(c) {
    return c === 96 ? (e.consume(c), r++, u) : (e.exit("codeTextSequence"), a(c));
  }
  function a(c) {
    return c === null
      ? n(c)
      : c === 32
        ? (e.enter("space"), e.consume(c), e.exit("space"), a)
        : c === 96
          ? ((o = e.enter("codeTextSequence")), (i = 0), f(c))
          : T(c)
            ? (e.enter("lineEnding"), e.consume(c), e.exit("lineEnding"), a)
            : (e.enter("codeTextData"), s(c));
  }
  function s(c) {
    return c === null || c === 32 || c === 96 || T(c)
      ? (e.exit("codeTextData"), a(c))
      : (e.consume(c), s);
  }
  function f(c) {
    return c === 96
...
function Tr(e) {
  ...
  for (; ++n < f.length; ) {
    ...
    if (r[0] === "enter") r[1].contentType && (Object.assign(t, to(f, n)), (n = t[n]), (s = !0));
...
function to(e, t) {
  ...
  for (h = n; ++p < u.length; )
    u[p][0] === "exit" &&
      ...
      ((b = p + 1), F.push(b), (h._tokenizer = void 0), (h.previous = void 0), (h = h.next));
  for (
    l.events = [], h ? ((h._tokenizer = void 0), (h.previous = void 0)) : F.pop(), p = F.length;
    p--;
  ) {
    const D = u.slice(F[p], F[p + 1]),
      E = o.pop();
    (a.push([E, E + D.length - 1]), e.splice(E, 2, D));
  }
  for (a.reverse(), p = -1; ++p < a.length; )
    ((s[g + a[p][0]] = g + a[p][1]), (g += a[p][1] - a[p][0] - 1));
  return s;
}
const ro = { resolve: lo, tokenize: oo },
  io = { partial: !0, tokenize: uo };
function lo(e) {
  return (Tr(e), e);
}
function oo(e, t) {
  ...
  function i(u) {
    return u === null ? o(u) : T(u) ? e.check(io, l, o)(u) : (e.consume(u), i);
  }
  function o(u) {
...
function Br(e, t, n, r, i, o, l, u, a) {
  const s = a || Number.POSITIVE_INFINITY;
  let f = 0;
  return c;
  function c(D) {
    return D === 60
      ? (e.enter(r), e.enter(i), e.enter(o), e.consume(D), e.exit(o), p)
      : D === null || D === 32 || D === 41 || sn(D)
        ? n(D)
        : (e.enter(r),
          e.enter(l),
          e.enter(u),
  ...
  function p(D) {
    return D === 62
      ...
      : (e.enter(u), e.enter("chunkString", { contentType: "string" }), h(D));
  }
  function h(D) {
    return D === 62
      ...
      : D === null || D === 60 || T(D)
        ? n(D)
        : (e.consume(D), D === 92 ? g : h);
  }
  function g(D) {
    return D === 60 || D === 62 || D === 92 ? (e.consume(D), h) : h(D);
  }
  function b(D) {
    return !f && (D === null || D === 41 || W(D))
      ? (e.exit("chunkString"), e.exit(u), e.exit(l), e.exit(r), t(D))
      : f < s && D === 40
        ? (e.consume(D), f++, b)
        : D === 41
          ? (e.consume(D), f--, b)
          : D === null || D === 32 || D === 40 || sn(D)
            ? n(D)
            : (e.consume(D), D === 92 ? F : b);
  }
  function F(D) {
    return D === 40 || D === 41 || D === 92 ? (e.consume(D), b) : b(D);
  }
}
function Pr(e, t, n, r, i, o) {
  ...
  function f(h) {
    return u > 999 ||
      ...
      h === 91 ||
      (h === 93 && !a) ||
      (h === 94 && !u && "_hiddenFootnoteSupport" in l.parser.constructs)
      ? n(h)
      : h === 93
  ...
  function c(h) {
    return h === null || h === 91 || h === 93 || T(h) || u++ > 999
      ? (e.exit("chunkString"), f(h))
      : (e.consume(h), a || (a = !z(h)), h === 92 ? p : c);
  }
  function p(h) {
...
function Lr(e, t, n, r, i, o) {
  ...
  function u(p) {
    return p === 34 || p === 39 || p === 40
      ? (e.enter(r), e.enter(i), e.consume(p), e.exit(i), (l = p === 40 ? 41 : p), a)
      : n(p);
  }
  function a(p) {
  ...
  function s(p) {
    return p === l
      ...
      : p === null
        ? n(p)
        : T(p)
          ? (e.enter("lineEnding"), e.consume(p), e.exit("lineEnding"), j(e, s, "linePrefix"))
          : (e.enter("chunkString", { contentType: "string" }), f(p));
  }
  function f(p) {
    return p === l || p === null || T(p)
...
function Ve(e, t) {
  ...
  function r(i) {
    return T(i)
      ...
      : z(i)
        ? j(e, r, n ? "linePrefix" : "lineSuffix")(i)
        : t(i);
  }
}
const ao = { name: "definition", tokenize: co },
...
function co(e, t, n) {
  ...
  function u(h) {
    return (
      (i = ce(r.sliceSerialize(r.events[r.events.length - 1][1]).slice(1, -1))),
      h === 58 ? (e.enter("definitionMarker"), e.consume(h), e.exit("definitionMarker"), a) : n(h)
    );
  }
  function a(h) {
    return W(h) ? Ve(e, s)(h) : s(h);
  }
  function s(h) {
    return Br(
      e,
  ...
  function f(h) {
    return e.attempt(so, c, c)(h);
  }
  function c(h) {
    return z(h) ? j(e, p, "whitespace")(h) : p(h);
  }
  function p(h) {
    return h === null || T(h) ? (e.exit("definition"), r.parser.defined.push(i), t(h)) : n(h);
  }
}
function fo(e, t, n) {
  return r;
  function r(u) {
    return W(u) ? Ve(e, i)(u) : n(u);
  }
  function i(u) {
    return Lr(e, o, n, "definitionTitle", "definitionTitleMarker", "definitionTitleString")(u);
  }
  function o(u) {
    return z(u) ? j(e, l, "whitespace")(u) : l(u);
  }
  function l(u) {
    return u === null || T(u) ? t(u) : n(u);
  }
}
const ho = { name: "hardBreakEscape", tokenize: po };
function po(e, t, n) {
  return r;
  function r(o) {
  ...
  function i(o) {
    return T(o) ? (e.exit("hardBreakEscape"), t(o)) : n(o);
  }
}
const mo = { name: "headingAtx", resolve: go, tokenize: Do };
function go(e, t) {
  let n = e.length - 2,
    r = 3,
    i,
...
function Do(e, t, n) {
  ...
  function u(f) {
    return f === 35
      ? (e.enter("atxHeadingSequence"), a(f))
      : f === null || T(f)
  ...
  function a(f) {
    return f === 35 ? (e.consume(f), a) : (e.exit("atxHeadingSequence"), u(f));
  }
  function s(f) {
    return f === null || f === 35 || W(f) ? (e.exit("atxHeadingText"), u(f)) : (e.consume(f), s);
  }
}
const yo = [
    "address",
  ...
  _t = ["pre", "script", "style", "textarea"],
  ko = { concrete: !0, name: "htmlFlow", resolveTo: Fo, tokenize: wo },
  xo = { partial: !0, tokenize: Eo },
  bo = { partial: !0, tokenize: Co };
function Fo(e) {
  let t = e.length;
...
function wo(e, t, n) {
  ...
  function c(d) {
    return d === 33
      ...
      : d === 47
        ? (e.consume(d), (o = !0), b)
        : d === 63
          ? (e.consume(d), (i = 3), r.interrupt ? t : m)
          : Z(d)
            ? (e.consume(d), (l = String.fromCharCode(d)), F)
            : n(d);
  }
  function p(d) {
    return d === 45
      ? (e.consume(d), (i = 2), h)
      : d === 91
        ? (e.consume(d), (i = 5), (u = 0), g)
        : Z(d)
          ? (e.consume(d), (i = 4), r.interrupt ? t : m)
          : n(d);
  }
  function h(d) {
  ...
  function g(d) {
    const ae = "CDATA[";
    return d === ae.charCodeAt(u++)
      ? (e.consume(d), u === ae.length ? (r.interrupt ? t : I) : g)
      : n(d);
  }
  function b(d) {
    return Z(d) ? (e.consume(d), (l = String.fromCharCode(d)), F) : n(d);
  }
  function F(d) {
    if (d === null || d === 47 || d === 62 || W(d)) {
      const ae = d === 47,
        be = l.toLowerCase();
      return !ae && !o && _t.includes(be)
        ? ((i = 1), r.interrupt ? t(d) : I(d))
        : yo.includes(l.toLowerCase())
          ? ((i = 6), ae ? (e.consume(d), D) : r.interrupt ? t(d) : I(d))
          : ((i = 7), r.interrupt && !r.parser.lazy[r.now().line] ? n(d) : o ? E(d) : w(d));
    }
    return d === 45 || X(d) ? (e.consume(d), (l += String.fromCharCode(d)), F) : n(d);
  }
  function D(d) {
    return d === 62 ? (e.consume(d), r.interrupt ? t : I) : n(d);
  }
  function E(d) {
    return z(d) ? (e.consume(d), E) : y(d);
  }
  function w(d) {
    return d === 47
      ? (e.consume(d), y)
  ...
  function _(d) {
    return d === 45 || d === 46 || d === 58 || d === 95 || X(d) ? (e.consume(d), _) : O(d);
  }
  function O(d) {
    return d === 61 ? (e.consume(d), x) : z(d) ? (e.consume(d), O) : w(d);
  }
  function x(d) {
  ...
  function M(d) {
    return d === a ? (e.consume(d), (a = null), U) : d === null || T(d) ? n(d) : (e.consume(d), M);
  }
  function q(d) {
    return d === null ||
      d === 34 ||
  ...
  function U(d) {
    return d === 47 || d === 62 || z(d) ? w(d) : n(d);
  }
  function y(d) {
    return d === 62 ? (e.consume(d), v) : n(d);
  }
  function v(d) {
    return d === null || T(d) ? I(d) : z(d) ? (e.consume(d), v) : n(d);
  }
  function I(d) {
    return d === 45 && i === 2
      ? (e.consume(d), V)
        ...
        : d === 62 && i === 4
          ...
          : d === 63 && i === 3
            ...
            : d === 93 && i === 5
              ? (e.consume(d), pe)
              : T(d) && (i === 6 || i === 7)
                ? (e.exit("htmlFlowData"), e.check(xo, me, H)(d))
                : d === null || T(d)
                  ? (e.exit("htmlFlowData"), H(d))
                  : (e.consume(d), I);
  }
  function H(d) {
    return e.check(bo, B, me)(d);
  }
  function B(d) {
    return (e.enter("lineEnding"), e.consume(d), e.exit("lineEnding"), S);
  }
  function S(d) {
    return d === null || T(d) ? H(d) : (e.enter("htmlFlowData"), I(d));
  }
  function V(d) {
    return d === 45 ? (e.consume(d), m) : I(d);
  }
  function K(d) {
    return d === 47 ? (e.consume(d), (l = ""), oe) : I(d);
  }
  function oe(d) {
    if (d === 62) {
      const ae = l.toLowerCase();
      return _t.includes(ae) ? (e.consume(d), ue) : I(d);
    }
    return Z(d) && l.length < 8 ? (e.consume(d), (l += String.fromCharCode(d)), oe) : I(d);
  }
  function pe(d) {
    return d === 93 ? (e.consume(d), m) : I(d);
  }
  function m(d) {
    return d === 62 ? (e.consume(d), ue) : d === 45 && i === 2 ? (e.consume(d), m) : I(d);
  }
  function ue(d) {
    return d === null || T(d) ? (e.exit("htmlFlowData"), me(d)) : (e.consume(d), ue);
  }
  function me(d) {
...
function Co(e, t, n) {
  ...
  return i;
  function i(l) {
    return T(l) ? (e.enter("lineEnding"), e.consume(l), e.exit("lineEnding"), o) : n(l);
  }
  function o(l) {
    return r.parser.lazy[r.now().line] ? n(l) : t(l);
  }
...
const Ao = { name: "htmlText", tokenize: So };
function So(e, t, n) {
  const r = this;
  let i, o, l;
  return u;
  function u(m) {
    return (e.enter("htmlText"), e.enter("htmlTextData"), e.consume(m), a);
  }
  function a(m) {
    return m === 33
      ? (e.consume(m), s)
  ...
  function g(m) {
    const ue = "CDATA[";
    return m === ue.charCodeAt(o++) ? (e.consume(m), o === ue.length ? b : g) : n(m);
  }
  function b(m) {
    return m === null
      ? n(m)
  ...
  function F(m) {
    return m === 93 ? (e.consume(m), D) : b(m);
  }
  function D(m) {
    return m === 62 ? V(m) : m === 93 ? (e.consume(m), D) : b(m);
  }
  function E(m) {
    return m === null || m === 62 ? V(m) : T(m) ? ((l = E), K(m)) : (e.consume(m), E);
  }
  function w(m) {
    return m === null
      ? n(m)
  ...
  function O(m) {
    return Z(m) ? (e.consume(m), x) : n(m);
  }
  function x(m) {
    return m === 45 || X(m) ? (e.consume(m), x) : M(m);
  }
  function M(m) {
    return T(m) ? ((l = M), K(m)) : z(m) ? (e.consume(m), M) : V(m);
  }
  function q(m) {
    return m === 45 || X(m) ? (e.consume(m), q) : m === 47 || m === 62 || W(m) ? U(m) : n(m);
  }
  function U(m) {
    return m === 47
      ? (e.consume(m), V)
  ...
  function y(m) {
    return m === 45 || m === 46 || m === 58 || m === 95 || X(m) ? (e.consume(m), y) : v(m);
  }
  function v(m) {
    return m === 61 ? (e.consume(m), I) : T(m) ? ((l = v), K(m)) : z(m) ? (e.consume(m), v) : U(m);
  }
  function I(m) {
...
const nt = { name: "labelEnd", resolveAll: Bo, resolveTo: Po, tokenize: Lo },
  vo = { tokenize: Ro },
  Io = { tokenize: _o },
  To = { tokenize: Oo };
function Bo(e) {
  ...
  return (e.length !== n.length && ie(e, 0, e.length, n), e);
}
function Po(e, t) {
  let n = e.length,
    r = 0,
  ...
  return (
    ...
    (u = le(u, e.slice(o + 1, o + r + 3))),
    (u = le(u, [["enter", f, t]])),
    (u = le(u, pn(t.parser.constructs.insideSpan.null, e.slice(o + r + 4, l - 3), t))),
    (u = le(u, [["exit", f, t], e[l - 2], e[l - 1], ["exit", s, t]])),
    (u = le(u, e.slice(l + 1))),
    (u = le(u, [["exit", a, t]])),
    ie(e, o, e.length, u),
    e
...
function Lo(e, t, n) {
  ...
  function u(p) {
    return o
      ? o._inactive
        ? c(p)
        : ((l = r.parser.defined.includes(ce(r.sliceSerialize({ start: o.end, end: r.now() })))),
          e.enter("labelEnd"),
          e.enter("labelMarker"),
          e.consume(p),
          e.exit("labelMarker"),
  ...
  function a(p) {
    return p === 40
      ? e.attempt(vo, f, l ? f : c)(p)
      : p === 91
        ? e.attempt(Io, f, l ? s : c)(p)
        : l
          ? f(p)
          : c(p);
  }
  function s(p) {
    return e.attempt(To, f, c)(p);
  }
  function f(p) {
    return t(p);
  }
...
function Ro(e, t, n) {
  ...
  function a(c) {
    return c === 34 || c === 39 || c === 40
      ? Lr(e, s, n, "resourceTitle", "resourceTitleMarker", "resourceTitleString")(c)
      : f(c);
  }
  function s(c) {
    return W(c) ? Ve(e, f)(c) : f(c);
  }
  function f(c) {
    return c === 41
...
function _o(e, t, n) {
  ...
  return i;
  function i(u) {
    return Pr.call(r, e, o, l, "reference", "referenceMarker", "referenceString")(u);
  }
  function o(u) {
    return r.parser.defined.includes(
      ce(r.sliceSerialize(r.events[r.events.length - 1][1]).slice(1, -1)),
    )
      ? t(u)
      : n(u);
  }
...
const zo = { name: "labelStartImage", resolveAll: nt.resolveAll, tokenize: Mo };
function Mo(e, t, n) {
  const r = this;
  return i;
  function i(u) {
  ...
  function o(u) {
    return u === 91
      ? (e.enter("labelMarker"), e.consume(u), e.exit("labelMarker"), e.exit("labelImage"), l)
      : n(u);
  }
  function l(u) {
...
const No = { name: "labelStartLink", resolveAll: nt.resolveAll, tokenize: jo };
function jo(e, t, n) {
  const r = this;
  return i;
  function i(l) {
...
const Fn = { name: "lineEnding", tokenize: Uo };
function Uo(e, t) {
  return n;
  function n(r) {
...
const un = { name: "thematicBreak", tokenize: qo };
function qo(e, t, n) {
  let r = 0,
    i;
  return o;
  ...
  function a(s) {
    return s === i
      ? (e.consume(s), r++, a)
      : (e.exit("thematicBreakSequence"), z(s) ? j(e, u, "whitespace")(s) : u(s));
  }
}
const ee = { continuation: { tokenize: Go }, exit: Yo, name: "list", tokenize: $o },
  Ho = { partial: !0, tokenize: Ko },
  Vo = { partial: !0, tokenize: Wo };
function $o(e, t, n) {
  const r = this,
  ...
  function u(h) {
    ...
    if (g === "listUnordered" ? !r.containerState.marker || h === r.containerState.marker : jn(h)) {
      if (
        (r.containerState.type || ((r.containerState.type = g), e.enter(g, { _container: !0 })),
        g === "listUnordered")
      )
        return (e.enter("listItemPrefix"), h === 42 || h === 45 ? e.check(un, n, s)(h) : s(h));
      if (!r.interrupt || h === 49)
  ...
  function s(h) {
    return (
      ...
      e.check(Xe, r.interrupt ? n : f, e.attempt(Ho, p, c))
    );
  }
  function f(h) {
...
function Go(e, t, n) {
  ...
  function i(u) {
    return (
      ...
      j(e, t, "listItemIndent", r.containerState.size + 1)(u)
    );
  }
  function o(u) {
    return r.containerState.furtherBlankLines || !z(u)
...
const Ot = { name: "setextUnderline", resolveTo: Qo, tokenize: Xo };
function Qo(e, t) {
  let n = e.length,
    r,
    i,
...
function Xo(e, t, n) {
  ...
  function u(s) {
    return s === i
      ? (e.consume(s), u)
      : (e.exit("setextHeadingLineSequence"), z(s) ? j(e, a, "lineSuffix")(s) : a(s));
  }
  function a(s) {
    return s === null || T(s) ? (e.exit("setextHeadingLine"), t(s)) : n(s);
  }
}
const Jo = { tokenize: Zo };
function Zo(e) {
  const t = this,
    n = e.attempt(
      Xe,
      ...
      e.attempt(
        ...
        i,
        j(e, e.attempt(this.parser.constructs.flow, i, e.attempt(ro, i)), "linePrefix"),
      ),
    );
  return n;
  function r(o) {
...
const eu = { resolveAll: _r() },
  nu = Rr("string"),
  tu = Rr("text");
function Rr(e) {
  return { resolveAll: _r(e === "text" ? ru : void 0), tokenize: t };
  function t(n) {
    const r = this,
    ...
    function a(f) {
      return s(f) ? (n.exit("data"), o(f)) : (n.consume(f), a);
    }
    function s(f) {
      if (f === null) return !0;
      const c = i[f];
...
const iu = {
  ...
  lu = { 91: ao },
  ou = { [-2]: bn, [-1]: bn, 32: bn },
  uu = { 35: mo, 42: un, 45: [Ot, un], 60: ko, 61: Ot, 95: un, 96: Rt, 126: Rt },
  au = { 38: Ir, 92: vr },
  su = {
    [-5]: Fn,
    [-4]: Fn,
...
function mu(e, t, n) {
  ...
  let f = t.tokenize.call(s, a);
  return (t.resolveAll && o.push(t), s);
  function c(v) {
    return (
      (l = le(l, v)),
      F(),
      l[l.length - 1] !== null ? [] : (q(t, 0), (s.events = pn(o, s.events, s)), s.events)
    );
  }
  function p(v, I) {
    return gu(h(v), I);
  ...
  function g() {
    const { _bufferIndex: v, _index: I, line: H, column: B, offset: S } = r;
    return { _bufferIndex: v, _index: I, line: H, column: B, offset: S };
  }
  function b(v) {
    ((i[v.line] = v.column), y());
  }
    ...
    for (; r._index < l.length; ) {
      ...
      if (typeof I == "string")
        for (
          ...
          r._index === v && r._bufferIndex < I.length;
        )
  ...
  function E(v) {
    (T(v)
      ? (r.line++, (r.column = 1), (r.offset += v === -3 ? 2 : 1), y())
  ...
  function w(v, I) {
    const H = I || {};
    return ((H.type = v), (H.start = g()), s.events.push(["enter", H, s]), u.push(H), H);
  }
  function _(v) {
    const I = u.pop();
    return ((I.end = g()), s.events.push(["exit", I, s]), I);
  }
  function O(v, I) {
    q(v, I.from);
  }
  ...
  function M(v, I) {
    ...
    function H(B, S, V) {
      let K, oe, pe, m;
      return Array.isArray(B) ? me(B) : "tokenize" in B ? me([B]) : ue(B);
      function ue(Q) {
        return Oe;
        function Oe(ye) {
          const ve = ye !== null && Q[ye],
            Ie = ye !== null && Q.null,
            en = [
      ...
      function me(Q) {
        return ((K = Q), (oe = 0), Q.length === 0 ? V : d(Q[oe]));
      }
      function d(Q) {
        return Oe;
        function Oe(ye) {
          return (
            ...
            Q.name && s.parser.constructs.disable.null.includes(Q.name)
              ? be()
              : Q.tokenize.call(I ? Object.assign(Object.create(s), I) : s, a, ae, be)(ye)
          );
        }
      }
      function ae(Q) {
      ...
      function be(Q) {
        return (m.restore(), ++oe < K.length ? d(K[oe]) : V);
      }
    }
  }
  function q(v, I) {
    (v.resolveAll && !o.includes(v) && o.push(v),
      v.resolve && ie(s.events, I, s.events.length - I, v.resolve(s.events.slice(I), s)),
      v.resolveTo && (s.events = v.resolveTo(s.events, s)));
  }
  function U() {
    const v = g(),
      I = s.previous,
      H = s.currentConstruct,
      B = s.events.length,
      S = Array.from(u);
    return { from: B, restore: V };
    function V() {
      ((r = v), (s.previous = I), (s.currentConstruct = H), (s.events.length = B), (u = S), y());
    }
  }
  function y() {
  ...
  function i(o, l, u) {
    ...
    for (
      ...
      if (h === 10 && c === p && r) (a.push(-3), (r = void 0));
        ...
        switch (
          (r && (a.push(-5), (r = void 0)), c < p && (a.push(o.slice(c, p)), (e += p - c)), h)
        ) {
          case 0: {
            (a.push(65533), e++);
            break;
...
function Fu(e, t, n) {
  ...
  if (n.charCodeAt(0) === 35) {
    const i = n.charCodeAt(1),
      o = i === 120 || i === 88;
    return Ar(n.slice(o ? 2 : 1), o ? 16 : 10);
  }
  return et(n) || e;
}
...
function Cu(e) {
  const t = {
    ...
    enter: {
      ...
      emphasis: o(wi),
      hardBreakEscape: o(pt),
      hardBreakTrailing: o(pt),
      htmlFlow: o(mt, l),
      htmlFlowData: U,
      htmlText: o(mt, l),
      htmlTextData: U,
  ...
  function r(k) {
    ...
    let $ = -1;
    for (; ++$ < k.length; )
      if (k[$][1].type === "listOrdered" || k[$][1].type === "listUnordered")
        if (k[$][0] === "enter") N.push($);
        else {
          const se = N.pop();
          $ = i(k, se, $);
    ...
    for ($ = -1; ++$ < k.length; ) {
      ...
      Or.call(se, k[$][1].type) &&
        se[k[$][1].type].call(
          Object.assign({ sliceSerialize: k[$][2].sliceSerialize }, L),
          k[$][1],
        );
    }
    ...
    for (
      A.position = {
        start: ke(k.length > 0 ? k[0][1].start : { line: 1, column: 1, offset: 0 }),
        end: ke(k.length > 0 ? k[k.length - 2][1].end : { line: 1, column: 1, offset: 0 }),
      },
        $ = -1;
      ++$ < t.transforms.length;
    )
  ...
  function i(k, A, L) {
    ...
    for (; ++N <= L; ) {
      ...
      switch (te[1].type) {
        ...
        case "listOrdered":
        case "blockQuote": {
          (te[0] === "enter" ? $++ : $--, (Me = void 0));
          break;
        }
        case "lineEndingBlank": {
          te[0] === "enter" && (Fe && !Me && !$ && !ze && (ze = N), (Me = void 0));
          break;
        }
        case "linePrefix":
        case "listItemValue":
      ...
      if (
        (!$ && te[0] === "enter" && te[1].type === "listItemPrefix") ||
        ($ === -1 &&
          te[0] === "exit" &&
          (te[1].type === "listUnordered" || te[1].type === "listOrdered"))
      ) {
        if (Fe) {
          let Te = N;
          for (de = void 0; Te--; ) {
            ...
            if (ge[1].type === "lineEnding" || ge[1].type === "lineEndingBlank") {
              ...
              (de && ((k[de][1].type = "lineEndingBlank"), (se = !0)),
          ...
          (ze && (!de || ze < de) && (Fe._spread = !0),
            (Fe.end = Object.assign({}, de ? k[de][1].start : te[1].end)),
            k.splice(de || N, 0, ["exit", Fe, te[2]]),
            N++,
            L++);
        }
        if (te[1].type === "listItemPrefix") {
          ...
          ((Fe = Te), k.splice(N, 0, ["enter", Te, te[2]]), N++, L++, (ze = void 0), (Me = !0));
        }
      }
    }
    return ((k[A][1]._spread = se), L);
  }
  function o(k, A) {
    return L;
    function L(N) {
      (u.call(this, k(N), N), A && A.call(this, N));
    }
  }
  function l() {
  ...
  function u(k, A, L) {
    (this.stack[this.stack.length - 1].children.push(k),
      ...
      (k.position = { start: ke(A.start), end: void 0 }));
  }
  function a(k) {
    return A;
    function A(L) {
  ...
  function s(k, A) {
    ...
    if (N) N[0].type !== k.type && (A ? A.call(this, k, N[0]) : (N[1] || Mt).call(this, k, N[0]));
    else
      throw new Error(
        "Cannot close `" + k.type + "` (" + He({ start: k.start, end: k.end }) + "): it’s not open",
      );
    L.position.end = ke(k.end);
  }
  function f() {
  ...
  function E(k) {
    ...
    ((L.label = A), (L.identifier = ce(this.sliceSerialize(k)).toLowerCase()));
  }
  function w() {
    const k = this.resume(),
      A = this.stack[this.stack.length - 1];
  ...
  function U(k) {
    ...
    let N = L[L.length - 1];
    ((!N || N.type !== "text") &&
      ((N = vi()), (N.position = { start: ke(k.start), end: void 0 }), L.push(N)),
      this.stack.push(N));
  }
  function y(k) {
    const A = this.stack.pop();
    ((A.value += this.sliceSerialize(k)), (A.position.end = ke(k.end)));
  }
  function v(k) {
    const A = this.stack[this.stack.length - 1];
    if (this.data.atHardBreak) {
      const L = A.children[A.children.length - 1];
      ((L.position.end = ke(k.end)), (this.data.atHardBreak = void 0));
      return;
    }
    !this.data.setextHeadingSlurpLineEnding &&
      t.canContainEols.includes(A.type) &&
      (U.call(this, k), y.call(this, k));
  }
  function I() {
  ...
  function V() {
    ...
    if (this.data.inReference) {
      ...
      ((k.type += "Reference"), (k.referenceType = A), delete k.url, delete k.title);
  ...
  function oe(k) {
    ...
    ((L.label = bu(A)), (L.identifier = ce(A).toLowerCase()));
  }
  function pe() {
    const k = this.stack[this.stack.length - 1],
      A = this.resume(),
  ...
  function ae(k) {
    const A = this.resume(),
      L = this.stack[this.stack.length - 1];
    ((L.label = A),
      (L.identifier = ce(this.sliceSerialize(k)).toLowerCase()),
  ...
  function Q(k) {
    ...
    let N;
    L
      ? ((N = Ar(A, L === "characterReferenceMarkerNumeric" ? 10 : 16)),
...
function Pu(e, t) {
  ...
  (u === void 0 ? ((u = 0), e.footnoteOrder.push(r), (l = e.footnoteOrder.length)) : (l = o + 1),
    (u += 1),
...
function Gu(e, t) {
  ...
  if (n.length > 0) {
    const l = { type: "element", tagName: "tbody", properties: {}, children: e.wrap(n, !0) },
      u = Kn(t.children[1]),
      a = yr(t.children[t.children.length - 1]);
...
function Wu(e, t, n) {
  const r = n ? n.children : void 0,
    ...
    u = l ? l.length : t.children.length;
  let a = -1;
  const s = [];
  for (; ++a < u; ) {
...
function Ku(e) {
  ...
  const o = [];
  for (; r; )
    (o.push(Ut(t.slice(i, r.index), i > 0, !0), r[0]),
      (i = r.index + r[0].length),
      (r = n.exec(t)));
  return (o.push(Ut(t.slice(i), i > 0, !1)), o.join(""));
}
function Ut(e, t, n) {
  let r = 0,
    i = e.length;
  if (t) {
    ...
    for (; o === Nt || o === jt; ) (r++, (o = e.codePointAt(r)));
  }
  if (n) {
    let o = e.codePointAt(i - 1);
    for (; o === Nt || o === jt; ) (i--, (o = e.codePointAt(i - 1)));
  }
...
const jr = -1,
  ...
  Ur = 7,
  qr = 8,
  Zu = typeof self == "object" ? self : globalThis,
  qt = (e, t) => {
    switch (e) {
      case "Function":
      case "SharedWorker":
  ...
  qe = (e) => {
    const t = typeof e;
    if (t !== "object" || !e) return [mn, t];
    const n = na.call(e).slice(8, -1);
    switch (n) {
      case "Array":
        return [$e, Ce];
      case "Object":
    ...
    return n.includes("Array") ? [$e, n] : n.includes("Error") ? [Ur, n] : [cn, n];
  },
  tn = ([e, t]) => e === mn && (t === "function" || t === "symbol"),
  ra = (e, t, n, r) => {
    const i = (l, u) => {
        const a = r.push(l) - 1;
        return (n.set(u, a), a);
      ...
      o = (l) => {
        ...
        switch (u) {
            ...
            if (a) {
              ...
              return (
                a === "DataView"
                  ...
                  : a === "ArrayBuffer" && (p = new Uint8Array(l)),
                i([a, [...p]], l)
              );
            }
            const f = [],
          ...
          case cn: {
            ...
            const f = [],
              c = i([u, f], l);
            for (const p of ta(l)) (e || !tn(qe(l[p]))) && f.push([o(p), o(l[p])]);
            return c;
          }
          case tt:
            return i([u, isNaN(l.getTime()) ? Ce : l.toISOString()], l);
          case rt: {
          ...
          case it: {
            const f = [],
              c = i([u, f], l);
            for (const [p, h] of l) (e || !(tn(qe(p)) || tn(qe(h)))) && f.push([o(p), o(h)]);
            return c;
          }
          case lt: {
            const f = [],
              c = i([u, f], l);
            for (const p of l) (e || !tn(qe(p))) && f.push(o(p));
            return c;
          }
        }
        const { message: s } = l;
  ...
  Vt = (e, { json: t, lossy: n } = {}) => {
    const r = [];
    return (ra(!(t || n), !!t, new Map(), r)(e), r);
  },
  Ye =
    typeof structuredClone == "function"
      ? (e, t) => (t && ("json" in t || "lossy" in t) ? Ht(Vt(e, t)) : structuredClone(e))
      : (e, t) => Ht(Vt(e, t));
function ia(e, t) {
...
function oa(e) {
  const t = typeof e.options.clobberPrefix == "string" ? e.options.clobberPrefix : "user-content-",
    n = e.options.footnoteBackContent || ia,
    r = e.options.footnoteBackLabel || la,
  ...
  for (; ++a < e.footnoteOrder.length; ) {
      ...
      (typeof E == "string" && (E = { type: "text", value: E }),
        g.push({
          ...
          properties: {
            ...
            dataFootnoteBackref: "",
            ariaLabel: typeof r == "string" ? r : r(a, h),
    ...
    if (F && F.type === "element" && F.tagName === "p") {
      ...
      (E && E.type === "text" ? (E.value += " ") : F.children.push({ type: "text", value: " " }),
        F.children.push(...g));
    } else f.push(...g);
    const D = {
      type: "element",
      ...
      children: [
        {
          type: "element",
          tagName: o,
          properties: { ...Ye(l), id: "footnote-label" },
...
const dn = function (e) {
  if (e == null) return ca;
  if (typeof e == "function") return gn(e);
  if (typeof e == "object") return Array.isArray(e) ? ua(e) : aa(e);
...
function gn(e) {
  return t;
  function t(n, r, i) {
    return !!(fa(n) && e.call(this, n, typeof r == "number" ? r : void 0, i || void 0));
  }
}
function ca() {
  return !0;
  ...
  function u(a, s, f) {
    ...
    function p() {
      let h = Hr,
        ...
        b,
        F;
      if ((!t || o(a, s, f[f.length - 1] || void 0)) && ((h = pa(n(a, f))), h[0] === qn)) return h;
      if ("children" in a && a.children) {
        const D = a;
        if (D.children && h[0] !== an)
          for (
            b = (r ? D.children.length : -1) + l, F = f.concat(D);
            b > -1 && b < D.children.length;
          ) {
            const E = D.children[b];
            if (((g = u(E, b, F)()), g[0] === qn)) return g;
...
function pa(e) {
  return Array.isArray(e) ? e : typeof e == "number" ? [ha, e] : e == null ? Hr : [e];
}
function Je(e, t, n, r) {
  let i, o, l;
  ...
  function u(a, s) {
    const f = s[s.length - 1],
      c = f ? f.children.indexOf(a) : void 0;
    return l(a, c, f);
  }
}
...
function da(e, t) {
  ...
  function a(f, c) {
    const p = f.type,
      h = u.handlers[p];
    if (Hn.call(u.handlers, p) && h) return h(u, f, c);
    if (u.options.passThrough && u.options.passThrough.includes(p)) {
      if ("children" in f) {
        const { children: b, ...F } = f,
          D = Ye(F);
        return ((D.children = u.all(f)), D);
      }
      return Ye(f);
    }
    return (u.options.unknownHandler || ya)(u, f, c);
  }
  function s(f) {
    const c = [];
    if ("children" in f) {
      ...
      for (; ++h < p.length; ) {
        ...
        if (g) {
          if (
            h &&
            p[h - 1].type === "break" &&
            (!Array.isArray(g) && g.type === "text" && (g.value = $t(g.value)),
            !Array.isArray(g) && g.type === "element")
          ) {
            const b = g.children[0];
            b && b.type === "text" && (b.value = $t(b.value));
          }
...
function Da(e, t) {
  ...
  if (e && e.data) {
    ...
    (n.type === "element" && o && Object.assign(n.properties, Ye(o)),
...
function ya(e, t) {
  const n = t.data || {},
    r =
      "value" in t && !(Hn.call(n, "hProperties") || Hn.call(n, "hChildren"))
...
function xa(e, t) {
  return e && "run" in e
    ? async function (n, r) {
        const i = Gt(n, { file: r, ...t });
        await e.run(i, r);
      }
    : function (n, r) {
        return Gt(n, { file: r, ...(e || t) });
      };
}
function Wt(e) {
  if (e) throw e;
  ...
  return (
    (wn = function a() {
      var s,
        ...
        E = !1;
      for (
        typeof b == "boolean" && ((E = b), (b = arguments[1] || {}), (F = 2)),
          (b == null || (typeof b != "object" && typeof b != "function")) && (b = {});
        F < D;
        ++F
      )
        if (((s = arguments[F]), s != null))
          for (f in s)
            ((c = u(b, f)),
              (p = u(s, f)),
              b !== p &&
                (E && p && (o(p) || (h = i(p)))
                  ? (h ? ((h = !1), (g = c && i(c) ? c : [])) : (g = c && o(c) ? c : {}),
                    l(b, { name: f, newValue: a(E, g, p) }))
                  : typeof p < "u" && l(b, { name: f, newValue: p })));
      return b;
    }),
    wn
  );
...
const fe = { basename: Ea, dirname: Aa, extname: Sa, join: va, sep: "/" };
function Ea(e, t) {
  ...
  for (; i--; )
    if (e.codePointAt(i) === 47) {
      ...
      (l < 0 && ((o = !0), (l = i + 1)),
        u > -1 &&
          (e.codePointAt(i) === t.codePointAt(u--) ? u < 0 && (r = i) : ((u = -1), (r = l))));
...
function va(...e) {
  let t = -1,
    n;
  for (; ++t < e.length; ) (Ze(e[t]), e[t] && (n = n === void 0 ? e[t] : n + "/" + e[t]));
...
function Ta(e, t) {
  let n = "",
    ...
    a;
  for (; ++l <= e.length; ) {
    if (l < e.length) u = e.codePointAt(l);
    else {
      if (u === 47) break;
      u = 47;
    }
...
const En = ["history", "path", "basename", "stem", "extname", "dirname"];
class $r {
  constructor(t) {
    let n;
    (t
      ? $n(t)
        ? (n = { path: t })
        : typeof t == "string" || _a(t)
          ? (n = { value: t })
          : (n = t)
      : (n = {}),
      (this.cwd = "cwd" in n ? "" : Ba.cwd()),
      (this.data = {}),
      (this.history = []),
      (this.messages = []),
      this.value,
    ...
    let i;
    for (i in n) En.includes(i) || (this[i] = n[i]);
  }
  get basename() {
    return typeof this.path == "string" ? fe.basename(this.path) : void 0;
  }
  set basename(t) {
    (Sn(t, "basename"), An(t, "basename"), (this.path = fe.join(this.dirname || "", t)));
  }
  get dirname() {
  ...
  set extname(t) {
    if ((An(t, "extname"), Kt(this.dirname, "extname"), t)) {
  ...
  set path(t) {
    ($n(t) && (t = La(t)), Sn(t, "path"), this.path !== t && this.history.push(t));
  }
  get stem() {
  ...
  set stem(t) {
    (Sn(t, "stem"),
      An(t, "stem"),
      (this.path = fe.join(this.dirname || "", t + (this.extname || ""))));
  }
  fail(t, n, r) {
...
function An(e, t) {
  if (e && e.includes(fe.sep))
    throw new Error("`" + t + "` cannot be a path: did not expect `" + fe.sep + "`");
}
function Sn(e, t) {
...
class ot extends Oa {
  ...
  data(t, n) {
    return typeof t == "string"
      ? arguments.length === 2
        ? (Tn("data", this.frozen), (this.namespace[t] = n), this)
        : (za.call(this.namespace, t) && this.namespace[t]) || void 0
      : t
        ? (Tn("data", this.frozen), (this.namespace = t), this)
        : this.namespace;
  }
  freeze() {
  ...
  process(t, n) {
    ...
    return (
      ...
      In("process", this.compiler || this.Compiler),
    ...
    function i(o, l) {
      ...
      r.run(a, u, function (f, c, p) {
        ...
        const h = c,
          g = r.stringify(h, p);
        (ja(g) ? (p.value = g) : (p.result = g), s(f, p));
      });
      function s(f, c) {
  ...
  processSync(t) {
    ...
    return (
      ...
      In("processSync", this.compiler || this.Compiler),
      this.process(t, i),
      Xt("processSync", "process", n),
      r
    );
    function i(o, l) {
      ((n = !0), Wt(o), (r = l));
  ...
  runSync(t, n) {
    let r = !1,
      i;
    return (this.run(t, n, o), Xt("runSync", "run", r), i);
    function o(l, u) {
      (Wt(l), (i = u), (r = !0));
    }
  }
  stringify(t, n) {
    ...
    return (In("stringify", i), Qt(t), i(t, r));
  }
  use(t, ...n) {
    const r = this.attachers,
      i = this.namespace;
    if ((Tn("use", this.frozen), t != null))
      if (typeof t == "function") a(t, n);
      else if (typeof t == "object") Array.isArray(t) ? u(t) : l(t);
    ...
    function l(s) {
      ...
      (u(s.plugins), s.settings && (i.settings = Cn(!0, i.settings, s.settings)));
    }
    function u(s) {
      let f = -1;
      if (s != null)
    ...
    function a(s, f) {
      ...
      if (p === -1) r.push([s, ...f]);
        ...
        let [h, ...g] = f;
        const b = r[p][1];
        (Vn(b) && Vn(h) && (h = Cn(!0, b, h)), (r[p] = [s, h, ...g]));
      }
    }
  }
}
const Ma = new ot().freeze();
function vn(e, t) {
...
const qa = "https://github.com/remarkjs/react-markdown/blob/main/changelog.md",
  Jt = [],
  Zt = { allowDangerousHtml: !0 },
  Ha = /^(https?|ircs?|mailto|xmpp)$/i,
  Va = [
...
function $a(e) {
  const t = Ga(e),
    n = Wa(e);
  return Ya(t.runSync(t.parse(n), n), e);
}
function Ga(e) {
  const t = e.rehypePlugins || Jt,
    n = e.remarkPlugins || Jt,
    r = e.remarkRehypeOptions ? { ...e.remarkRehypeOptions, ...Zt } : Zt;
  return Ma().use(Au).use(n).use(xa, r).use(t);
}
function Wa(e) {
  const t = e.children || "",
    n = new $r();
...
function Ya(e, t) {
  ...
  for (const f of Va)
    Object.hasOwn(t, f.from) &&
      ("" + f.from + (f.to ? "use `" + f.to + "` instead" : "remove it") + qa + f.id, void 0);
  return (
    Je(e, s),
    al(e, {
      Fragment: R.Fragment,
  ...
  function s(f, c, p) {
    ...
    if (f.type === "element") {
      let h;
      for (h in xn)
        if (Object.hasOwn(xn, h) && Object.hasOwn(f.properties, h)) {
          const g = f.properties[h],
            b = xn[h];
          (b === null || b.includes(f.tagName)) && (f.properties[h] = a(String(g || ""), h, f));
        }
    }
    if (f.type === "element") {
      ...
      if ((!h && r && typeof c == "number" && (h = !r(f, c, p)), h && p && typeof c == "number"))
        return (
          u && f.children ? p.children.splice(c, 1, ...f.children) : p.children.splice(c, 1),
          c
        );
    }
  }
...
function Xa(e, t, n) {
  ...
  function a(s, f) {
    ...
    for (; w; ) {
      const _ = w.index,
        O = { index: w.index, input: w.input, stack: [...f, s] };
      let x = h(...w, O);
      if (
        (typeof x == "string" && (x = x.length > 0 ? { type: "text", value: x } : void 0),
        x === !1
          ? (p.lastIndex = _ + 1)
          : (g !== _ && E.push({ type: "text", value: s.value.slice(g, _) }),
    ...
    return (
      D
        ? (g < s.value.length && E.push({ type: "text", value: s.value.slice(g) }),
          c.children.splice(F, 1, ...E))
        : (E = [s]),
      F + E.length
    );
  }
...
function Ja(e) {
  ...
  for (; ++r < n.length; ) {
    const i = n[r];
    t.push([Za(i[0]), es(i[1])]);
  }
  return t;
}
function Za(e) {
  return typeof e == "string" ? new RegExp(Qa(e), "g") : e;
}
function es(e) {
...
function ts() {
  return {
    unsafe: [
      ...
      { character: ".", before: "[Ww]", after: "[\\-.\\w]", inConstruct: Bn, notInConstruct: Pn },
      { character: ":", before: "[ps]", after: "\\/", inConstruct: Bn, notInConstruct: Pn },
    ],
  };
}
function rs(e) {
...
function ss(e, t, n, r, i) {
  let o = "";
  if (!Gr(i) || (/^w/i.test(t) && ((n = t + n), (t = ""), (o = "http://")), !fs(n))) return !1;
  const l = hs(n + r);
  if (!l[0]) return !1;
  const u = {
    type: "link",
...
function Gr(e, t) {
  ...
  return (e.index === 0 || Ae(n) || hn(n)) && (!t || n !== 47);
}
Wr.peek = bs;
function ps() {
  this.buffer();
...
function Ds(e) {
  ...
  (n.type, (n.identifier = ce(this.sliceSerialize(e)).toLowerCase()), (n.label = t));
}
function ys(e) {
  this.exit(e);
}
...
function Fs() {
  return {
    ...
    exit: {
      ...
      gfmFootnoteCall: ys,
      gfmFootnoteDefinitionLabelString: ks,
...
function ws(e) {
  ...
  function n(r, i, o, l) {
    ...
    const s = o.enter("footnoteDefinition"),
      f = o.enter("label");
    return (
      (a += u.move(o.safe(o.associationId(r), { before: a, after: "]" }))),
      f(),
      (a += u.move("]:")),
      r.children &&
        r.children.length > 0 &&
        ...
        (a += u.move(
          (t
            ? `
`
            : " ") + o.indentLines(o.containerFlow(r, u.current()), t ? Yr : Cs),
        ))),
      s(),
      a
    );
...
Kr.peek = Ts;
function As() {
  return { canContainEols: ["delete"], enter: { strikethrough: vs }, exit: { strikethrough: Is } };
}
function Ss() {
  return {
    unsafe: [{ character: "~", inConstruct: "phrasing", notInConstruct: Es }],
    handlers: { delete: Kr },
  };
}
function vs(e) {
...
function Ps(e, t) {
  ...
  for (; ++f < e.length; ) {
    const b = [],
      F = [];
    let D = -1;
    for (e[f].length > s && (s = e[f].length); ++D < e[f].length; ) {
      const E = Ls(e[f][D]);
      if (n.alignDelimiters !== !1) {
        const w = i(E);
        ((F[D] = w), (a[D] === void 0 || w > a[D]) && (a[D] = w));
      }
      b.push(E);
    }
    ((l[f] = b), (u[f] = F));
  ...
  let c = -1;
  if (typeof r == "object" && "length" in r) for (; ++c < s; ) o[c] = nr(r[c]);
  else {
    const b = nr(r);
    for (; ++c < s; ) o[c] = b;
  }
  ...
  for (; ++c < s; ) {
    ...
    let F = "",
      D = "";
    b === 99 ? ((F = ":"), (D = ":")) : b === 108 ? (F = ":") : b === 114 && (D = ":");
    let E = n.alignDelimiters === !1 ? 1 : Math.max(1, a[c] - F.length - D.length);
    const w = F + "-".repeat(E) + D;
    (n.alignDelimiters !== !1 &&
      ((E = F.length + E + D.length), E > a[c] && (a[c] = E), (h[c] = E)),
      (p[c] = w));
  }
    ...
    for (; ++c < s; ) {
      ...
      if (n.alignDelimiters !== !1) {
        ...
        x === 114
          ...
          : x === 99
            ? O % 2
              ? ((w = " ".repeat(O / 2 + 0.5)), (_ = " ".repeat(O / 2 - 0.5)))
              : ((w = " ".repeat(O / 2)), (_ = w))
            : (_ = " ".repeat(O));
      }
      (n.delimiterStart !== !1 && !c && D.push("|"),
        n.padding !== !1 &&
          !(n.alignDelimiters === !1 && E === "") &&
          (n.delimiterStart !== !1 || c) &&
          D.push(" "),
        n.alignDelimiters !== !1 && D.push(w),
        D.push(E),
        n.alignDelimiters !== !1 && D.push(_),
        n.padding !== !1 && D.push(" "),
        (n.delimiterEnd !== !1 || c !== s - 1) && D.push("|"));
    }
...
function Rs(e, t, n, r) {
  const i = n.enter("blockquote"),
    o = n.createTracker(r);
  (o.move("> "), o.shift(2));
  const l = n.indentLines(n.containerFlow(e, o.current()), _s);
  return (i(), l);
}
function _s(e, t, n) {
  return ">" + (n ? "" : " ") + e;
...
function Os(e, t) {
  return tr(e, t.inConstruct, !0) && !tr(e, t.notInConstruct, !1);
}
function tr(e, t, n) {
...
function js(e, t, n, r) {
  ...
  if (Ms(e, n)) {
    const c = n.enter("codeIndented"),
      p = n.indentLines(o, Us);
    return (c(), p);
  }
  const u = n.createTracker(r),
    a = i.repeat(Math.max(zs(o, i) + 1, 3)),
    s = n.enter("codeFenced");
  let f = u.move(a);
  if (e.lang) {
    const c = n.enter(`codeFencedLang${l}`);
    ((f += u.move(n.safe(e.lang, { before: f, after: " ", encode: ["`"], ...u.current() }))), c());
  }
  if (e.lang && e.meta) {
...
function Qr(e, t, n, r) {
  const i = Hs(n),
    ...
    l = n.createTracker(r),
    u = l.move(i);
  let a = l.move(n.containerPhrasing(e, { after: i, before: u, ...l.current() }));
  const s = a.charCodeAt(0),
    f = fn(r.before.charCodeAt(r.before.length - 1), s, i);
  f.inside && (a = Ke(s) + a.slice(1));
  const c = a.charCodeAt(a.length - 1),
    p = fn(r.after.charCodeAt(0), c, i);
  p.inside && (a = a.slice(0, -1) + Ke(c));
  const h = l.move(i);
  return (
    o(),
...
function $s(e, t) {
  ...
  return (
    Je(e, function (r) {
      if (("value" in r && /\r?\n|\r/.test(r.value)) || r.type === "break") return ((n = !0), qn);
    }),
...
`,
  ...
  return (
    /^[\t ]/.test(s) && (s = Ke(s.charCodeAt(0)) + s.slice(1)),
    (s = s ? l + " " + s : l),
...
function Zr(e, t, n, r) {
  ...
  const u = n.createTracker(r);
  let a = u.move("![");
  const s = n.safe(e.alt, { before: a, after: "]", ...u.current() });
  ((a += u.move(s + "][")), l());
  const f = n.stack;
  ((n.stack = []), (l = n.enter("reference")));
  const c = n.safe(n.associationId(e), { before: a, after: "]", ...u.current() });
  return (
    l(),
    (n.stack = f),
    o(),
...
function ri(e, t, n, r) {
  ...
  const u = n.createTracker(r);
  let a = u.move("[");
  const s = n.containerPhrasing(e, { before: a, after: "]", ...u.current() });
  ((a += u.move(s + "][")), l());
  const f = n.stack;
  ((n.stack = []), (l = n.enter("reference")));
  const c = n.safe(n.associationId(e), { before: a, after: "]", ...u.current() });
...
function nc(e, t, n, r) {
  const i = n.enter("list"),
    o = n.bulletCurrent;
  let l = e.ordered ? ec(n) : at(n);
  const u = e.ordered ? (l === "." ? ")" : ".") : Zs(n);
...
function rc(e, t, n, r) {
  ...
  const a = n.enter("listItem"),
    s = n.indentLines(n.containerFlow(e, u.current()), f);
  return (a(), s);
  function f(c, p, h) {
...
function fc(e, t, n) {
  const r = (ii(n) + (n.options.ruleSpaces ? " " : "")).repeat(cc(n));
...
function hc() {
  return {
    enter: { table: pc, tableData: ir, tableHeader: ir, tableRow: dc },
    exit: { codeText: gc, table: mc, tableData: Rn, tableHeader: Rn, tableRow: Rn },
  };
}
function pc(e) {
  const t = e._align;
...
`,
    ...
    handlers: { inlineCode: p, table: l, tableCell: a, tableRow: u },
  };
  function l(h, g, b, F) {
    return s(f(h, b, F), h.align);
  }
  function u(h, g, b, F) {
    const D = c(h, b, F),
      E = s([D]);
...
`),
  ...
  function a(h, g, b, F) {
    const D = b.enter("tableCell"),
      E = b.enter("phrasing"),
      w = b.containerPhrasing(h, { ...F, before: o, after: o });
    return (E(), D(), w);
  }
  function s(h, g) {
    return Ps(h, { align: g, alignDelimiters: r, padding: n, stringLength: i });
  }
  function f(h, g, b) {
    const F = h.children;
    let D = -1;
  ...
  function c(h, g, b) {
    ...
    const E = [],
      w = g.enter("tableRow");
    for (; ++D < F.length; ) E[D] = a(F[D], h, g, b);
    return (w(), E);
  }
  function p(h, g, b) {
    let F = oi.inlineCode(h, g, b);
    return (b.stack.includes("tableCell") && (F = F.replace(/\|/g, "\\$&")), F);
  }
}
function kc() {
  return {
    exit: { taskListCheckValueChecked: lr, taskListCheckValueUnchecked: lr, paragraph: bc },
  };
}
function xc() {
  return { unsafe: [{ atBreak: !0, character: "-", after: "[:|-]" }], handlers: { listItem: Fc } };
}
function lr(e) {
...
function Fc(e, t, n, r) {
  const i = e.children[0],
    ...
    u = n.createTracker(r);
  o && u.move(l);
  let a = oi.listItem(e, t, n, { ...r, ...u.current() });
...
function wc() {
  return [ns(), Fs(), As(), hc(), kc()];
}
function Cc(e) {
  return { extensions: [ts(), ws(e), Ss(), yc(e), xc()] };
}
const Ec = { tokenize: Bc, partial: !0 },
  ui = { tokenize: Pc, partial: !0 },
  ai = { tokenize: Lc, partial: !0 },
  si = { tokenize: Rc, partial: !0 },
  Ac = { tokenize: _c, partial: !0 },
  ci = { name: "wwwAutolink", tokenize: Ic, previous: hi },
  fi = { name: "protocolAutolink", tokenize: Tc, previous: pi },
  De = { name: "emailAutolink", tokenize: vc, previous: mi },
  he = {};
function Sc() {
  return { text: he };
}
let we = 48;
for (; we < 123; ) ((he[we] = De), we++, we === 58 ? (we = 65) : we === 91 && (we = 97));
he[43] = De;
he[45] = De;
he[46] = De;
he[95] = De;
...
function vc(e, t, n) {
  ...
  return l;
  function l(c) {
    return !Gn(c) || !mi.call(r, r.previous) || st(r.events)
      ? n(c)
      : (e.enter("literalAutolink"), e.enter("literalAutolinkEmail"), u(c));
  }
  function u(c) {
    return Gn(c) ? (e.consume(c), u) : c === 64 ? (e.consume(c), a) : n(c);
  }
  function a(c) {
    return c === 46
      ? e.check(Ac, f, s)(c)
...
function Ic(e, t, n) {
  ...
  return i;
  function i(l) {
    return (l !== 87 && l !== 119) || !hi.call(r, r.previous) || st(r.events)
      ? n(l)
      : (e.enter("literalAutolink"),
        e.enter("literalAutolinkWww"),
        e.check(Ec, e.attempt(ui, e.attempt(ai, o), n), n)(l));
  }
  function o(l) {
...
function Tc(e, t, n) {
  ...
  return l;
  function l(c) {
    return (c === 72 || c === 104) && pi.call(r, r.previous) && !st(r.events)
      ? (e.enter("literalAutolink"),
  ...
  function u(c) {
    if (Z(c) && i.length < 5) return ((i += String.fromCodePoint(c)), e.consume(c), u);
    if (c === 58) {
      const p = i.toLowerCase();
      if (p === "http" || p === "https") return (e.consume(c), a);
    }
    return n(c);
  }
  function a(c) {
  ...
  function s(c) {
    return c === null || sn(c) || W(c) || Ae(c) || hn(c)
      ? n(c)
      : e.attempt(ui, e.attempt(ai, f), n)(c);
  }
  function f(c) {
  ...
  function r(u) {
    return u === 33 ||
      ...
      : u === 38
        ...
        : u === 93
          ? (e.consume(u), i)
          : u === 60 || u === null || W(u) || Ae(u)
            ? t(u)
            : n(u);
  }
  function i(u) {
    return u === null || u === 40 || u === 91 || W(u) || Ae(u) ? t(u) : r(u);
  }
  function o(u) {
    return Z(u) ? l(u) : n(u);
  }
  function l(u) {
    return u === 59 ? (e.consume(u), r) : Z(u) ? (e.consume(u), l) : n(u);
  }
}
function _c(e, t, n) {
  return r;
...
function hi(e) {
  return (
    e === null || e === 40 || e === 42 || e === 95 || e === 91 || e === 93 || e === 126 || W(e)
  );
}
function pi(e) {
  return !Z(e);
...
const Oc = { tokenize: Vc, partial: !0 };
function zc() {
  return {
    document: {
      91: { name: "gfmFootnoteDefinition", tokenize: Uc, continuation: { tokenize: qc }, exit: Hc },
    },
    text: {
      91: { name: "gfmFootnoteCall", tokenize: jc },
      93: { name: "gfmPotentialFootnoteCall", add: "after", tokenize: Mc, resolveTo: Nc },
    },
  };
}
function Mc(e, t, n) {
...
function jc(e, t, n) {
  ...
  function s(c) {
    if (o > 999 || (c === 93 && !l) || c === null || c === 91 || W(c)) return n(c);
    if (c === 93) {
      e.exit("chunkString");
      const p = e.exit("gfmFootnoteCallString");
      return i.includes(ce(r.sliceSerialize(p)))
        ? (e.enter("gfmFootnoteCallLabelMarker"),
          e.consume(c),
          e.exit("gfmFootnoteCallLabelMarker"),
    ...
    return (W(c) || (l = !0), o++, e.consume(c), c === 92 ? f : s);
  }
  function f(c) {
...
function Uc(e, t, n) {
  ...
  function f(g) {
    if (l > 999 || (g === 93 && !u) || g === null || g === 91 || W(g)) return n(g);
    if (g === 93) {
      e.exit("chunkString");
      const b = e.exit("gfmFootnoteDefinitionLabelString");
      return (
        (o = ce(r.sliceSerialize(b))),
        e.enter("gfmFootnoteDefinitionLabelMarker"),
        e.consume(g),
        e.exit("gfmFootnoteDefinitionLabelMarker"),
    ...
    return (W(g) || (u = !0), l++, e.consume(g), g === 92 ? c : f);
  }
  function c(g) {
  ...
  function p(g) {
    return g === 58
      ? (e.enter("definitionMarker"),
        ...
        j(e, h, "gfmFootnoteDefinitionWhitespace"))
      : n(g);
  }
  function h(g) {
    return t(g);
...
function qc(e, t, n) {
  return e.check(Xe, t, e.attempt(Oc, t, n));
}
function Hc(e) {
...
function $c(e) {
  ...
  function i(l, u) {
    ...
    for (; ++a < l.length; )
      if (
        l[a][0] === "enter" &&
        l[a][1].type === "strikethroughSequenceTemporary" &&
        l[a][1]._close
      ) {
        let s = a;
        for (; s--; )
          if (
            ...
            l[s][1]._open &&
            l[a][1].end.offset - l[a][1].start.offset === l[s][1].end.offset - l[s][1].start.offset
          ) {
            ...
            const f = {
              ...
              h = u.parser.constructs.insideSpan.null;
            (h && ie(p, p.length, 0, pn(h, l.slice(s + 1, a), u)),
              ie(p, p.length, 0, [
                ["exit", c, u],
                ["enter", l[a][1], u],
                ["exit", l[a][1], u],
  ...
  function o(l, u, a) {
    ...
    function p(g) {
      return s === 126 && f[f.length - 1][1].type !== "characterEscape"
        ? a(g)
        : (l.enter("strikethroughSequenceTemporary"), h(g));
    }
    function h(g) {
      const b = Le(s);
      if (g === 126) return c > 1 ? a(g) : (l.consume(g), c++, h);
      if (c < 2 && !n) return a(g);
      const F = l.exit("strikethroughSequenceTemporary"),
        D = Le(g);
      return ((F._open = !D || (D === 2 && !!b)), (F._close = !b || (b === 2 && !!D)), u(g));
    }
  }
}
class Gc {
...
function Kc() {
  return { flow: { null: { name: "table", tokenize: Qc, resolveAll: Xc } } };
}
function Qc(e, t, n) {
  const r = this;
  let i = 0,
  ...
  function u(y) {
    ...
    for (; v > -1; ) {
      const B = r.events[v][1].type;
      if (B === "lineEnding" || B === "linePrefix") v--;
      else break;
    }
    const I = v > -1 ? r.events[v][1].type : null,
      H = I === "tableHead" || I === "tableRow" ? x : a;
    return H === x && r.parser.lazy[r.now().line] ? n(y) : H(y);
  }
  function a(y) {
      ...
      : T(y)
        ...
        : z(y)
          ...
          : ((o += 1),
            l && ((l = !1), (i += 1)),
            y === 124
              ? (e.enter("tableCellDivider"), e.consume(y), e.exit("tableCellDivider"), (l = !0), f)
              : (e.enter("data"), c(y)));
  }
  function c(y) {
    return y === null || y === 124 || W(y)
      ? (e.exit("data"), f(y))
      : (e.consume(y), y === 92 ? p : c);
  }
  function p(y) {
  ...
  function g(y) {
    return y === 45 || y === 58
      ? F(y)
      : y === 124
        ? ((l = !0), e.enter("tableCellDivider"), e.consume(y), e.exit("tableCellDivider"), b)
        : O(y);
  }
  function b(y) {
    return z(y) ? j(e, F, "whitespace")(y) : F(y);
  }
  function F(y) {
    return y === 58
      ? ((o += 1),
  ...
  function D(y) {
    return y === 45 ? (e.enter("tableDelimiterFiller"), E(y)) : O(y);
  }
  function E(y) {
    return y === 45
      ? (e.consume(y), E)
      : y === 58
        ? ((l = !0),
          ...
          e.exit("tableDelimiterMarker"),
          w)
        : (e.exit("tableDelimiterFiller"), w(y));
  }
  function w(y) {
    return z(y) ? j(e, _, "whitespace")(y) : _(y);
  }
  function _(y) {
    return y === 124
      ? g(y)
      : y === null || T(y)
        ? !l || i !== o
          ? O(y)
          : (e.exit("tableDelimiterRow"), e.exit("tableHead"), t(y))
        : O(y);
  }
  function O(y) {
    return n(y);
  ...
  function x(y) {
    return (e.enter("tableRow"), M(y));
  }
  function M(y) {
    return y === 124
      ? (e.enter("tableCellDivider"), e.consume(y), e.exit("tableCellDivider"), M)
      : y === null || T(y)
        ? (e.exit("tableRow"), t(y))
        : z(y)
          ? j(e, M, "whitespace")(y)
...
function Xc(e, t) {
  ...
  for (; ++n < e.length; ) {
    ...
    h[0] === "enter"
      ? g.type === "tableHead"
        ? ((u = !1),
          a !== 0 && (or(p, t, a, s, f), (f = void 0), (a = 0)),
          (s = { type: "table", start: Object.assign({}, g.start), end: Object.assign({}, g.end) }),
          p.add(n, 0, [["enter", s, t]]))
        : g.type === "tableRow" || g.type === "tableDelimiterRow"
          ...
          : i &&
            ...
            ? ((r = !1),
              l[2] === 0 &&
                (o[1] !== 0 && ((l[0] = l[1]), (c = ln(p, t, o, i, void 0, c)), (o = [0, 0, 0, 0])),
                (l[2] = n)))
            : g.type === "tableCellDivider" &&
              (r
                ? (r = !1)
                : (o[1] !== 0 && ((l[0] = l[1]), (c = ln(p, t, o, i, void 0, c))),
                  (o = l),
                  (l = [o[1], n, 0, 0])))
      : g.type === "tableHead"
        ? ((u = !0), (a = n))
        : g.type === "tableRow" || g.type === "tableDelimiterRow"
          ? ((a = n),
            o[1] !== 0
              ? ((l[0] = l[1]), (c = ln(p, t, o, i, n, c)))
              : l[1] !== 0 && (c = ln(p, t, l, i, n, c)),
            (i = 0))
          : i &&
            (g.type === "data" ||
              g.type === "tableDelimiterMarker" ||
  ...
  for (a !== 0 && or(p, t, a, s, f), p.consume(t.events), n = -1; ++n < t.events.length; ) {
    const h = t.events[n];
    h[0] === "enter" && h[1].type === "table" && (h[1]._align = Yc(t.events, n));
  }
  return e;
}
function ln(e, t, n, r, i, o) {
  const l = r === 1 ? "tableHeader" : r === 2 ? "tableDelimiter" : "tableData",
    u = "tableContent";
  n[0] !== 0 && ((o.end = Object.assign({}, Pe(t.events, n[0]))), e.add(n[0], 0, [["exit", o, t]]));
  const a = Pe(t.events, n[1]);
  if (
    ((o = { type: l, start: Object.assign({}, a), end: Object.assign({}, a) }),
    e.add(n[1], 0, [["enter", o, t]]),
    n[2] !== 0)
  ) {
    const s = Pe(t.events, n[2]),
      f = Pe(t.events, n[3]),
      c = { type: u, start: Object.assign({}, s), end: Object.assign({}, f) };
  ...
  return (
    i !== void 0 &&
      ((o.end = Object.assign({}, Pe(t.events, i))), e.add(i, 0, [["exit", o, t]]), (o = void 0)),
    o
  );
}
...
const Jc = { name: "tasklistCheck", tokenize: ef };
function Zc() {
  return { text: { 91: Jc } };
}
function ef(e, t, n) {
  ...
  function u(a) {
    return T(a) ? t(a) : z(a) ? e.check({ tokenize: nf }, t, n)(a) : n(a);
  }
}
function nf(e, t, n) {
...
class di {
  ...
  slug(t, n) {
    ...
    let i = af(t, n === !0);
    const o = i;
    for (; uf.call(r.occurrences, i); ) (r.occurrences[o]++, (i = o + "-" + r.occurrences[o]));
...
function af(e, t) {
  return typeof e != "string"
    ? ""
    : (t || (e = e.toLowerCase()), e.replace(of, "").replace(/ /g, "-"));
}
function gi(e) {
  const t = e.type === "element" ? e.tagName.toLowerCase() : "",
    n = t.length === 2 && t.charCodeAt(0) === 104 ? t.charCodeAt(1) : 0;
  return n > 48 && n < 55 ? n - 48 : void 0;
}
function sf(e) {
  return "children" in e ? Di(e) : "value" in e ? e.value : "";
}
function cf(e) {
  return e.type === "text" ? e.value : "children" in e ? Di(e) : "";
}
function Di(e) {
  let t = -1;
  const n = [];
  for (; ++t < e.children.length; ) n[t] = cf(e.children[t]);
  return n.join("");
}
const ff = {},
  ur = new di();
function hf(e) {
  ...
  return function (r) {
    (ur.reset(),
      Je(r, "element", function (i) {
        gi(i) && !i.properties.id && (i.properties.id = n + ur.slug(sf(i)));
      }));
  };
}
const yi = function (e) {
  if (e == null) return df;
  if (typeof e == "string") return mf(e);
  if (typeof e == "object") return pf(e);
...
function ct(e) {
  return t;
  function t(n, r, i) {
    return !!(gf(n) && e.call(this, n, typeof r == "number" ? r : void 0, i || void 0));
  }
}
function df(e) {
  return !!(
...
function yf(e) {
  const t = e || Df;
  let n = t.properties;
  const r = t.headingProperties,
    i = t.behavior || "prepend",
    o = t.content,
    l = t.group,
    u = yi(t.test);
  let a;
  return (
    i === "after" || i === "before"
      ...
      : i === "wrap"
        ? (a = c)
        : ((a = s), n || (n = { ariaHidden: "true", tabIndex: -1 })),
    function (p) {
      Je(p, "element", function (h, g, b) {
        if (gi(h) && h.properties.id && u(h, g, b))
          return (Object.assign(h.properties, on(r, h)), a(h, g, b));
      });
    }
  );
  function s(p) {
    const h = sr(o || ar, p);
    return (p.children[i === "prepend" ? "unshift" : "push"](_n(p, on(n, p), h)), [an]);
  }
  function f(p, h, g) {
    if (typeof h != "number" || !g) return;
    const b = sr(o || ar, p),
      F = _n(p, on(n, p), b);
    let D = i === "before" ? [F, p] : [p, F];
    if (l) {
      const E = ki(l, p);
      E && !Array.isArray(E) && E.type === "element" && ((E.children = D), (D = [E]));
    }
    return (g.children.splice(h, 1, ...D), [an, h + D.length]);
  }
  function c(p) {
    let h = p.children,
      g = [];
    return (
      typeof o == "function" ? ((h = []), (g = o(p))) : o && (g = ft(o)),
      (p.children = [_n(p, on(n, p), Array.isArray(g) ? [...h, ...g] : [...h, g])]),
      [an]
    );
  }
}
...
function ki(e, t) {
  return typeof e == "function" ? e(t) : ft(e);
}
function on(e, t) {
  return typeof e == "function" ? e(t) : e ? ft(e) : {};
}
const kf = {
  ...
  pre: ({ children: e }) =>
    R.jsx("pre", {
      className:
        "docs-code-block overflow-x-auto rounded-md border border-border bg-terminal p-4 text-xs leading-relaxed text-terminal-foreground",
      children: e,
    }),
  code: ({ className: e, children: t, ...n }) =>
    e?.includes("language-")
      ? R.jsx("code", { className: Ge("font-mono", e), ...n, children: t })
      : R.jsx("code", {
          className:
            "rounded-sm border border-border bg-secondary/60 px-1 py-0.5 text-[0.9em] text-foreground",
          ...n,
          children: t,
        }),
  table: ({ children: e }) =>
    R.jsx("div", {
      className: "docs-table-wrap overflow-x-auto rounded-md border border-border bg-card",
      children: R.jsx("table", { children: e }),
    }),
  h2: ({ id: e, children: t, ...n }) =>
    R.jsx("h2", { id: e, className: "docs-heading docs-h2", ...n, children: t }),
  h3: ({ id: e, children: t, ...n }) =>
    R.jsx("h3", { id: e, className: "docs-heading docs-h3", ...n, children: t }),
};
function xf({ content: e, className: t }) {
  return R.jsx("article", {
    className: Ge("docs-prose", t),
    children: R.jsx($a, {
      remarkPlugins: [lf],
      rehypePlugins: [hf, [yf, { behavior: "wrap" }]],
      components: kf,
      children: e,
    }),
  });
...
function Ff(e) {
  ...
  for (; (i = r.exec(e)) !== null; ) {
    const o = i[1].length,
      l = bf(i[2]);
    n.push({ level: o, text: l, id: t.slug(l) });
  }
  return n;
}
const xi =
...
function Af() {
  return R.jsxs("div", {
    ...
    children: [
      R.jsx(Ti, {}),
      R.jsxs("main", {
        className: "editorial-shell nav-offset pb-10 sm:pb-14",
        children: [
          R.jsxs("div", {
            className: "mb-8 border-b border-dashed border-border pb-8",
            children: [
              R.jsx("p", { className: "text-xs text-muted-foreground", children: "[docs]" }),
              R.jsx("h1", {
          ...
          R.jsxs("div", {
            className:
              "grid gap-8 lg:grid-cols-[minmax(0,15rem)_minmax(0,1fr)] lg:gap-10 xl:grid-cols-[minmax(0,16.5rem)_minmax(0,1fr)] xl:gap-12",
            children: [R.jsx(Li, { items: wf }), R.jsx(xf, { content: xi })],
          }),
        ],
      }),
      R.jsx(Bi, {}),
