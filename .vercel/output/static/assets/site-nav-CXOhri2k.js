import { j as i, L as $, r as ke } from "./index-Bt-2xMU-.js";
function Ce(e) {
  var t,
    o,
    r = "";
  if (typeof e == "string" || typeof e == "number") r += e;
    ...
    if (Array.isArray(e)) {
      var a = e.length;
      for (t = 0; t < a; t++) e[t] && (o = Ce(e[t])) && (r && (r += " "), (r += o));
    } else for (o in e) e[o] && (r && (r += " "), (r += o));
  return r;
}
function De() {
  for (var e, t, o = 0, r = "", a = arguments.length; o < a; o++)
    (e = arguments[o]) && (t = Ce(e)) && (r && (r += " "), (r += t));
  return r;
}
const We = (e, t) => {
  ...
  Be = (e, t) => ({ classGroupId: e, validator: t }),
  Se = (e = new Map(), t = null, o) => ({ nextPart: e, validators: t, classGroupId: o }),
  ee = "-",
  we = [],
  $e = "arbitrary..",
  Ue = (e) => {
  ...
  Ae = (e, t, o) => {
    ...
    if (l === null) return;
    const b = t === 0 ? e.join(ee) : e.slice(t).join(ee),
      p = l.length;
    for (let f = 0; f < p; f++) {
      const x = l[f];
      if (x.validator(b)) return x.classGroupId;
    }
  },
  Ye = (e) =>
  ...
  Re = (e, t) => {
    ...
    for (let m = 0; m < a; m++) {
      ...
      (b || ((b = Se()), o.nextPart.set(l, b)), (o = b));
    }
    return o;
  },
  Ze = (e) => "isThemeGetter" in e && e.isThemeGetter === !0,
  er = (e) => {
    ...
    const a = (m, l) => {
      ((o[m] = l), t++, t > e && ((t = 0), (r = o), (o = Object.create(null))));
    };
    return {
      get(m) {
        let l = o[m];
        if (l !== void 0) return l;
        if ((l = r[m]) !== void 0) return (a(m, l), l);
      },
      set(m, l) {
        m in o ? (o[m] = l) : a(m, l);
      },
  ...
  or = (e) => {
    ...
    let r = (a) => {
      ...
      const j = m.length === 0 ? a : a.slice(p);
      let C = j,
        M = !1;
      j.endsWith(ie)
        ? ((C = j.slice(0, -1)), (M = !0))
        : j.startsWith(ie) && ((C = j.slice(1)), (M = !0));
      const P = f && f > p ? f - p : void 0;
      return ye(m, M, C, P);
    };
    if (t) {
      const a = t + ve,
        m = r;
      r = (l) => (l.startsWith(a) ? m(l.slice(a.length)) : ye(rr, !1, l, void 0, !0));
    }
    if (o) {
      const a = r;
      r = (m) => o({ className: m, parseClassName: a });
    }
    return r;
  },
  tr = (e) => {
      ...
      (o) => {
        ...
        for (let m = 0; m < o.length; m++) {
          const l = o[m],
            b = l[0] === "[",
            p = t.has(l);
          b || p ? (a.length > 0 && (a.sort(), r.push(...a), (a = [])), r.push(l)) : a.push(l);
        }
        return (a.length > 0 && (a.sort(), r.push(...a)), r);
      }
    );
  },
  sr = (e) => ({ cache: er(e.cacheSize), parseClassName: or(e), sortModifiers: tr(e), ...Ue(e) }),
  nr = /\s+/,
  ar = (e, t) => {
    const {
        parseClassName: o,
    ...
    for (let f = b.length - 1; f >= 0; f -= 1) {
      ...
      const U = C.length === 0 ? "" : C.length === 1 ? C[0] : m(C).join(":"),
        D = M ? U + ie : U,
        E = D + L;
      if (l.indexOf(E) > -1) continue;
      l.push(E);
      const V = a(L, v);
  ...
  ir = (...e) => {
    let t = 0,
      ...
      r,
      a = "";
    for (; t < e.length; ) (o = e[t++]) && (r = Ie(o)) && (a && (a += " "), (a += r));
    return a;
  },
  Ie = (e) => {
    ...
    let t,
      o = "";
    for (let r = 0; r < e.length; r++) e[r] && (t = Ie(e[r])) && (o && (o += " "), (o += t));
    return o;
  },
  lr = (e, ...t) => {
    let o, r, a, m;
    const l = (p) => {
        const f = t.reduce((x, j) => j(x), e());
        return ((o = sr(f)), (r = o.cache.get), (a = o.cache.set), (m = b), b(p));
      },
      b = (p) => {
        const f = r(p);
        if (f) return f;
  ...
  br = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/,
  fr =
    /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/,
  A = (e) => dr.test(e),
  u = (e) => !!e && !Number.isNaN(Number(e)),
  R = (e) => !!e && Number.isInteger(Number(e)),
  ae = (e) => e.endsWith("%") && u(e.slice(0, -1)),
  S = (e) => mr.test(e),
  Le = () => !0,
  gr = (e) => pr.test(e) && !ur.test(e),
  de = () => !1,
  hr = (e) => br.test(e),
  xr = (e) => fr.test(e),
  kr = (e) => !s(e) && !n(e),
  ...
  Ge = (e) => e === "image" || e === "url",
  Oe = (e) => e === "length" || e === "size" || e === "bg-size",
  _e = (e) => e === "length",
  Ar = (e) => e === "number",
  Ee = (e) => e === "family-name",
  Ve = (e) => e === "number" || e === "weight",
  Fe = (e) => e === "shadow",
  Rr = () => {
    const e = g("color"),
      t = g("font"),
      ...
      c = () => [n, s, p],
      y = () => [A, "full", "auto", ...c()],
      me = () => [R, "none", "subgrid", n, s],
      pe = () => ["auto", { span: ["full", R, n, s] }, R, n, s],
      Y = () => [R, "auto", n, s],
      ue = () => ["auto", "min", "max", "fr", n, s],
      re = () => [
        "start",
        "end",
        "center",
      ...
      oe = () => [A, "screen", "full", "dvw", "lvw", "svw", "min", "max", "fit", ...c()],
      te = () => [A, "screen", "full", "lh", "dvh", "lvh", "svh", "min", "max", "fit", ...c()],
      d = () => [e, n, s],
      be = () => [...E(), Ne, ze, { position: [n, s] }],
      fe = () => ["no-repeat", { repeat: ["", "x", "y", "space", "round"] }],
      ge = () => ["auto", "cover", "contain", Nr, wr, { size: [n, s] }],
      se = () => [ae, B, O],
      k = () => ["", "none", "full", f, n, s],
      w = () => ["", u, B, O],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: ["auto", "square", A, s, n, v] }],
        container: ["container"],
        ...
        z: [{ z: [R, "auto", n, s] }],
        basis: [{ basis: [A, "full", "auto", b, ...c()] }],
        "flex-direction": [{ flex: ["row", "row-reverse", "col", "col-reverse"] }],
        "flex-wrap": [{ flex: ["nowrap", "wrap", "wrap-reverse"] }],
        flex: [{ flex: [u, A, "auto", "initial", "none", s] }],
        grow: [{ grow: ["", u, n, s] }],
        shrink: [{ shrink: ["", u, n, s] }],
        ...
        "max-w": [{ "max-w": [b, "screen", "none", "prose", { screen: [l] }, ...G()] }],
        h: [{ h: ["screen", "lh", ...G()] }],
        ...
        "line-clamp": [{ "line-clamp": [u, "none", n, je] }],
        leading: [{ leading: [m, ...c()] }],
        ...
        "text-decoration-thickness": [{ decoration: [u, "from-font", "auto", n, O] }],
        ...
        "bg-image": [
          {
            bg: [
              "none",
              {
                linear: [{ to: ["t", "tr", "r", "br", "b", "bl", "l", "tl"] }, R, n, s],
                radial: ["", n, s],
                conic: [R, n, s],
              },
              Cr,
        ...
        shadow: [{ shadow: ["", "none", x, Q, K] }],
        "shadow-color": [{ shadow: d() }],
        "inset-shadow": [{ "inset-shadow": ["none", j, Q, K] }],
        ...
        "text-shadow": [{ "text-shadow": ["none", C, Q, K] }],
        ...
        "drop-shadow": [{ "drop-shadow": ["", "none", M, Q, K] }],
...
const Mr = "/agent%20dev%20white%20logo.png";
function le({ variant: e = "light", className: t }) {
  return i.jsx("img", {
    src: Mr,
    alt: "",
    "aria-hidden": !0,
    className: Z("h-4 w-4 shrink-0 object-contain", e === "light" && "invert", t),
  });
}
function Gr() {
  return i.jsx("footer", {
    className: "mt-16 border-t border-border/60 bg-card/70",
    children: i.jsxs("div", {
      className: "editorial-shell py-14",
      children: [
        i.jsxs("div", {
          className: "grid gap-10 border-b border-border/60 pb-10 md:grid-cols-4",
          children: [
            i.jsxs("div", {
              ...
              children: [
                i.jsxs("div", {
                  ...
                  children: [
                    i.jsx(le, { variant: "light" }),
                    i.jsx("span", { children: "agent-dev" }),
                  ],
                }),
                i.jsx("p", {
                  className: "mt-4 max-w-md text-sm leading-relaxed text-muted-foreground",
                  children:
                    "The terminal coding agent for autonomous development workflows. Open source, scriptable, and built to keep coding fast inside your terminal.",
                }),
                i.jsx("p", {
                  className: "editorial-label mt-4 text-muted-foreground",
                  children: "MIT licensed · built with Ink",
                }),
              ],
            }),
            i.jsxs("div", {
              children: [
                i.jsx("p", {
                  className: "editorial-label mb-4 text-muted-foreground",
                  children: "Product",
                }),
                i.jsxs("div", {
        ...
        i.jsxs("div", {
          className:
            "mt-6 flex flex-col gap-3 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between",
          children: [
            i.jsxs("p", {
              children: [
                "© ",
            ...
            i.jsx("p", {
              ...
              children: "Open source · ship from terminal",
            }),
          ],
        }),
      ],
...
const Pr = 24,
  Lr = i.jsxs(i.Fragment, {
    children: [
      i.jsx($, { to: "/docs", className: "transition-colors hover:opacity-100", children: "docs" }),
      i.jsx("a", {
        href: "/#install",
    ...
    i.jsx("header", {
      ...
      children: i.jsx("div", {
        className: Z(
          ...
          a ? "editorial-shell" : "w-full px-4 sm:px-6 lg:px-10",
        ),
        children:
          r && !t
            ? i.jsxs("div", {
                ...
                children: [
                  ...
                  i.jsx("nav", {
                    className:
                      "editorial-shadow absolute left-1/2 hidden -translate-x-1/2 items-center gap-5 rounded-full border border-white/60 bg-white/90 px-6 py-2.5 text-[11px] uppercase tracking-[0.08em] text-foreground/70 backdrop-blur-md lg:flex",
                    children: Lr,
                  }),
                  i.jsxs("div", {
                    ...
                    children: [
                      i.jsx("a", {
                        ...
                        rel: "noreferrer",
                        className:
                          "inline-flex h-9 items-center justify-center rounded-full border border-border px-3 text-[11px] uppercase tracking-[0.08em] text-foreground/80 transition-colors hover:bg-secondary lg:hidden",
                        children: "feedback",
                      }),
                      i.jsx("a", {
                        href: "https://www.npmjs.com/package/@devang0907/agent-dev",
                        ...
                        rel: "noreferrer",
                        className:
                          "inline-flex h-10 items-center rounded-full border border-foreground/15 bg-white/90 px-4 text-[11px] font-semibold uppercase tracking-[0.08em] text-foreground backdrop-blur-sm transition-transform hover:scale-[1.02]",
            ...
            : i.jsxs("div", {
                ...
                children: [
                  i.jsxs($, {
                    ...
                    children: [
                      i.jsx(le, { variant: "dark" }),
                      i.jsx("span", { children: "agent-dev" }),
                    ],
                  }),
                  i.jsxs("nav", {
                    className:
                      "hidden items-center gap-6 text-[11px] uppercase tracking-[0.08em] text-primary-foreground/70 lg:flex",
                    children: [
                      i.jsx($, {
                        to: "/docs",
                  ...
                  i.jsxs("div", {
                    ...
                    children: [
                      i.jsx("a", {
                        ...
                        rel: "noreferrer",
                        className:
                          "inline-flex h-9 items-center justify-center rounded-md border border-primary-foreground/20 px-3 text-[11px] uppercase tracking-[0.08em] text-primary-foreground/80 transition-colors hover:bg-primary-foreground/10 hover:text-primary-foreground lg:hidden",
                        children: "feedback",
                      }),
                      i.jsx("a", {
                        href: "https://www.npmjs.com/package/@devang0907/agent-dev",
                        ...
                        rel: "noreferrer",
                        className:
                          "inline-flex h-10 items-center gap-1.5 rounded-full bg-primary-foreground px-4 text-[11px] font-semibold uppercase tracking-[0.08em] text-primary transition-transform hover:scale-[1.02]",
                        children: "try agent-dev",
                      }),
                    ],
                  }),
